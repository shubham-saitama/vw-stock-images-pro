...
$custom_css .= 'html body,h1,h2,h3,h4,h5,h6,a,div,label,button,p,td,tr,table,ul,li,th{
	';
...
if ($vw_stock_images_pro_hi_first_color != false) {
	$custom_css .= ':root{
				--primary: ' . esc_html($vw_stock_images_pro_hi_first_color) . '!important;
			}';
}
/*-------------------Secondry Color --------------------*/
...
if ($vw_stock_images_pro_headermenu_color != false || $vw_stock_images_pro_headermenu_font_family != false || $vw_stock_images_pro_headermenu_font_size != false) {
	$custom_css .= 'nav#site-navigation ul li a{';
...
if ($vw_stock_images_pro_header_menuhovercolor != false) {
	$custom_css .= 'nav#site-navigation ul li a:hover{';
...
if ($vw_stock_images_pro_dropdownbg_itemcolor != false || $vw_stock_images_pro_dropdownbg_item_font_family != false || $vw_stock_images_pro_dropdownbg_item_font_size != false) {
	$custom_css .= 'nav#site-navigation ul.sub-menu li a{';
...
$vw_stock_images_pro_menubg_color = get_theme_mod('vw_stock_images_pro_menubg_color');

if ($vw_stock_images_pro_menubg_color != false) {
	$custom_css .= '.primary_nav{';
	$custom_css .= 'background-color: ' . esc_html($vw_stock_images_pro_menubg_color) . ';';
	$custom_css .= '}';
}
if ($vw_stock_images_pro_dropdownbg_item_hovercolor != false) {
	$custom_css .= 'nav#site-navigation ul.sub-menu li a:hover{';
...
if ($vw_stock_images_pro_header_icon_color != false || $vw_stock_images_pro_header_icon_font_size != false) {
	$custom_css .= 'div#menu-toggleBtn i{';
...
if ($vw_stock_images_pro_header_close_iconcolor != false) {
	$custom_css .= '.cross-button i::before{
...
$vw_stock_images_pro_header_pricing_link_color = get_theme_mod('vw_stock_images_pro_header_pricing_link_color');
$vw_stock_images_pro_header_pricing_link_family = get_theme_mod('vw_stock_images_pro_header_pricing_link_family');
$vw_stock_images_pro_header_pricing_link_size = get_theme_mod('vw_stock_images_pro_header_pricing_link_size');
if ($vw_stock_images_pro_header_pricing_link_color != false || $vw_stock_images_pro_header_pricing_link_family != false || $vw_stock_images_pro_header_pricing_link_size != false) {
	$custom_css .= '.profile-search .border-right{';
	if ($vw_stock_images_pro_header_pricing_link_color != false) {
		$custom_css .= 'color: ' . esc_html($vw_stock_images_pro_header_pricing_link_color) . ';';
	}
	if ($vw_stock_images_pro_header_pricing_link_family != false) {
		$custom_css .= 'font-family:' . esc_html($vw_stock_images_pro_header_pricing_link_family) . ';';
	}
	if ($vw_stock_images_pro_header_pricing_link_size != false) {
		$custom_css .= 'font-size:' . esc_html($vw_stock_images_pro_header_pricing_link_size) . 'px;';
	}
	$custom_css .= '}';
}
/*-----------------------Slider Section-------------------------*/
...
if ($vw_stock_images_pro_pests_problem_heading_color != false || $vw_stock_images_pro_pests_problem_heading_font_family != false || $vw_stock_images_pro_pests_problem_heading_font_size != false) {
	$custom_css .= 'section#pests-problem h2.section-heading{';
...
if ($vw_stock_images_pro_pests_problem_paragraph_color != false || $vw_stock_images_pro_pests_problem_paragraph_font_family != false || $vw_stock_images_pro_pests_problem_paragraph_font_size != false) {
	$custom_css .= 'section#pests-problem p.section-heading-text{';
...
$vw_stock_images_pro_trending_sec_author_name_color = get_theme_mod('vw_stock_images_pro_trending_sec_author_name_color');
$vw_stock_images_pro_trending_sec_author_name_font_size = get_theme_mod('vw_stock_images_pro_trending_sec_author_name_font_size');
$vw_stock_images_pro_trending_sec_author_name_font_family = get_theme_mod('vw_stock_images_pro_trending_sec_author_name_font_family');
$vw_stock_images_pro_trending_sec_author_name_font_weight = get_theme_mod('vw_stock_images_pro_trending_sec_author_name_font_weight');

if ($vw_stock_images_pro_trending_sec_author_name_color != false || $vw_stock_images_pro_trending_sec_author_name_font_family != false || $vw_stock_images_pro_trending_sec_author_name_font_size != false || $vw_stock_images_pro_trending_sec_author_name_font_weight != false) {
	$custom_css .= 'section#pests-problem .author-download{';
	if ($vw_stock_images_pro_trending_sec_author_name_color != false) {
		$custom_css .= 'color: ' . esc_html($vw_stock_images_pro_trending_sec_author_name_color) . ' ;';
	}
	if ($vw_stock_images_pro_trending_sec_author_name_font_family != false) {
		$custom_css .= 'font-family:' . esc_html($vw_stock_images_pro_trending_sec_author_name_font_family) . ' ;';
	}
	if ($vw_stock_images_pro_trending_sec_author_name_font_size != false) {
		$custom_css .= 'font-size:' . esc_html($vw_stock_images_pro_trending_sec_author_name_font_size) . 'px ;';
	}
	if ($vw_stock_images_pro_trending_sec_author_name_font_weight != false) {
		$custom_css .= 'font-weight:' . esc_html($vw_stock_images_pro_trending_sec_author_name_font_weight) . ' ;';
	}
	$custom_css .= '}';
}
...
$vw_stock_images_pro_category_slider_heading_color = get_theme_mod('vw_stock_images_pro_category_slider_heading_color');
$vw_stock_images_pro_category_slider_heading_font_size = get_theme_mod('vw_stock_images_pro_category_slider_heading_font_size');
$vw_stock_images_pro_cat_slider_heading_font_family = get_theme_mod('vw_stock_images_pro_cat_slider_heading_font_family');
$vw_stock_images_pro_category_slider_heading_font_weight = get_theme_mod('vw_stock_images_pro_category_slider_heading_font_weight');

if ($vw_stock_images_pro_category_slider_heading_color != false || $vw_stock_images_pro_cat_slider_heading_font_family != false || $vw_stock_images_pro_category_slider_heading_font_size != false || $vw_stock_images_pro_category_slider_heading_font_weight != false) {
	$custom_css .= 'section#category-slider h2.section-heading{';
	if ($vw_stock_images_pro_category_slider_heading_color != false) {
		$custom_css .= 'color: ' . esc_html($vw_stock_images_pro_category_slider_heading_color) . ' ;';
	}
	if ($vw_stock_images_pro_cat_slider_heading_font_family != false) {
		$custom_css .= 'font-family:' . esc_html($vw_stock_images_pro_cat_slider_heading_font_family) . ' ;';
	}
	if ($vw_stock_images_pro_category_slider_heading_font_size != false) {
		$custom_css .= 'font-size:' . esc_html($vw_stock_images_pro_category_slider_heading_font_size) . 'px ;';
	}
	if ($vw_stock_images_pro_category_slider_heading_font_weight != false) {
		$custom_css .= 'font-weight:' . esc_html($vw_stock_images_pro_category_slider_heading_font_weight) . ' ;';
	}
	$custom_css .= '}';
}
...
$vw_stock_images_pro_category_slider_heading_text_color = get_theme_mod('vw_stock_images_pro_category_slider_heading_text_color');
$vw_stock_images_pro_category_slider_heading_text_font_size = get_theme_mod('vw_stock_images_pro_category_slider_heading_text_font_size');
$vw_stock_images_pro_category_slider_heading_text_font_family = get_theme_mod('vw_stock_images_pro_category_slider_heading_text_font_family');
$vw_stock_images_pro_category_slider_heading_text_font_weight = get_theme_mod('vw_stock_images_pro_category_slider_heading_text_font_weight');

if ($vw_stock_images_pro_category_slider_heading_text_color != false || $vw_stock_images_pro_category_slider_heading_text_font_family != false || $vw_stock_images_pro_category_slider_heading_text_font_size != false || $vw_stock_images_pro_category_slider_heading_text_font_weight != false) {
	$custom_css .= ' section#category-slider p.section-heading-text{';
	if ($vw_stock_images_pro_category_slider_heading_text_color != false) {
		$custom_css .= 'color: ' . esc_html($vw_stock_images_pro_category_slider_heading_text_color) . ' ;';
	}
	if ($vw_stock_images_pro_category_slider_heading_text_font_family != false) {
		$custom_css .= 'font-family:' . esc_html($vw_stock_images_pro_category_slider_heading_text_font_family) . ' ;';
	}
	if ($vw_stock_images_pro_category_slider_heading_text_font_size != false) {
		$custom_css .= 'font-size:' . esc_html($vw_stock_images_pro_category_slider_heading_text_font_size) . 'px ;';
	}
	if ($vw_stock_images_pro_category_slider_heading_text_font_weight != false) {
		$custom_css .= 'font-weight:' . esc_html($vw_stock_images_pro_category_slider_heading_text_font_weight) . ' ;';
	}
	$custom_css .= '}';
}

$vw_stock_images_pro_category_slider_category_name_text_color = get_theme_mod('vw_stock_images_pro_category_slider_category_name_text_color');
$vw_stock_images_pro_category_slider_category_name_text_font_size = get_theme_mod('vw_stock_images_pro_category_slider_category_name_text_font_size');
$vw_stock_images_pro_category_slider_category_name_text_font_family = get_theme_mod('vw_stock_images_pro_category_slider_category_name_text_font_family');
$vw_stock_images_pro_category_slider_category_name_text_font_weight = get_theme_mod('vw_stock_images_pro_category_slider_category_name_text_font_weight');

if ($vw_stock_images_pro_category_slider_category_name_text_color != false || $vw_stock_images_pro_category_slider_category_name_text_font_family != false || $vw_stock_images_pro_category_slider_category_name_text_font_size != false || $vw_stock_images_pro_category_slider_category_name_text_font_weight != false) {
	$custom_css .= '.card-content h3.category-title{';
	if ($vw_stock_images_pro_category_slider_category_name_text_color != false) {
		$custom_css .= 'color: ' . esc_html($vw_stock_images_pro_category_slider_category_name_text_color) . ' ;';
	}
	if ($vw_stock_images_pro_category_slider_category_name_text_font_family != false) {
		$custom_css .= 'font-family:' . esc_html($vw_stock_images_pro_category_slider_category_name_text_font_family) . ' ;';
	}
	if ($vw_stock_images_pro_category_slider_category_name_text_font_size != false) {
		$custom_css .= 'font-size:' . esc_html($vw_stock_images_pro_category_slider_category_name_text_font_size) . 'px ;';
	}
	if ($vw_stock_images_pro_category_slider_category_name_text_font_weight != false) {
		$custom_css .= 'font-weight:' . esc_html($vw_stock_images_pro_category_slider_category_name_text_font_weight) . ' ;';
	}
	$custom_css .= '}';
}

$vw_stock_images_pro_category_slider_category_desc_color = get_theme_mod('vw_stock_images_pro_category_slider_category_desc_color');
$vw_stock_images_pro_category_slider_category_desc_font_size = get_theme_mod('vw_stock_images_pro_category_slider_category_desc_font_size');
$vw_stock_images_pro_category_slider_category_desc_font_family = get_theme_mod('vw_stock_images_pro_category_slider_category_desc_font_family');
$vw_stock_images_pro_category_slider_category_desc_font_weight = get_theme_mod('vw_stock_images_pro_category_slider_category_desc_font_weight');

if ($vw_stock_images_pro_category_slider_category_desc_color != false || $vw_stock_images_pro_category_slider_category_desc_font_family != false || $vw_stock_images_pro_category_slider_category_desc_font_size != false || $vw_stock_images_pro_category_slider_category_desc_font_weight != false) {
	$custom_css .= 'p.category-description.text-center{';
	if ($vw_stock_images_pro_category_slider_category_desc_color != false) {
		$custom_css .= 'color: ' . esc_html($vw_stock_images_pro_category_slider_category_desc_color) . ' ;';
	}
	if ($vw_stock_images_pro_category_slider_category_desc_font_family != false) {
		$custom_css .= 'font-family:' . esc_html($vw_stock_images_pro_category_slider_category_desc_font_family) . ' ;';
	}
	if ($vw_stock_images_pro_category_slider_category_desc_font_size != false) {
		$custom_css .= 'font-size:' . esc_html($vw_stock_images_pro_category_slider_category_desc_font_size) . 'px ;';
	}
	if ($vw_stock_images_pro_category_slider_category_desc_font_weight != false) {
		$custom_css .= 'font-weight:' . esc_html($vw_stock_images_pro_category_slider_category_desc_font_weight) . ' ;';
	}
	$custom_css .= '}';
}
...
$vw_stock_images_pro_our_features_sec_feature_title_color = get_theme_mod('vw_stock_images_pro_our_features_sec_feature_title_color');
$vw_stock_images_pro_our_features_sec_feature_title_font_size = get_theme_mod('vw_stock_images_pro_our_features_sec_feature_title_font_size');
$vw_stock_images_pro_our_features_sec_feature_title_font_family = get_theme_mod('vw_stock_images_pro_our_features_sec_feature_title_font_family');
$vw_stock_images_pro_our_features_sec_feature_title_font_weight = get_theme_mod('vw_stock_images_pro_our_features_sec_feature_title_font_weight');

if ($vw_stock_images_pro_our_features_sec_feature_title_color != false || $vw_stock_images_pro_our_features_sec_feature_title_font_family != false || $vw_stock_images_pro_our_features_sec_feature_title_font_size != false || $vw_stock_images_pro_our_features_sec_feature_title_font_weight != false) {
	$custom_css .= '.feature-card h4{';
	if ($vw_stock_images_pro_our_features_sec_feature_title_color != false) {
		$custom_css .= 'color: ' . esc_html($vw_stock_images_pro_our_features_sec_feature_title_color) . ' ;';
	}
	if ($vw_stock_images_pro_our_features_sec_feature_title_font_family != false) {
		$custom_css .= 'font-family:' . esc_html($vw_stock_images_pro_our_features_sec_feature_title_font_family) . ' ;';
	}
	if ($vw_stock_images_pro_our_features_sec_feature_title_font_size != false) {
		$custom_css .= 'font-size:' . esc_html($vw_stock_images_pro_our_features_sec_feature_title_font_size) . 'px ;';
	}
	if ($vw_stock_images_pro_our_features_sec_feature_title_font_weight != false) {
		$custom_css .= 'font-weight:' . esc_html($vw_stock_images_pro_our_features_sec_feature_title_font_weight) . ' ;';
	}
	$custom_css .= '}';
}
$vw_stock_images_pro_our_features_sec_feature_desc_color = get_theme_mod('vw_stock_images_pro_our_features_sec_feature_desc_color');
$vw_stock_images_pro_our_features_sec_feature_desc_font_size = get_theme_mod('vw_stock_images_pro_our_features_sec_feature_desc_font_size');
$vw_stock_images_pro_our_features_sec_feature_desc_font_family = get_theme_mod('vw_stock_images_pro_our_features_sec_feature_desc_font_family');
$vw_stock_images_pro_our_features_sec_feature_desc_font_weight = get_theme_mod('vw_stock_images_pro_our_features_sec_feature_desc_font_weight');

if ($vw_stock_images_pro_our_features_sec_feature_desc_color != false || $vw_stock_images_pro_our_features_sec_feature_desc_font_family != false || $vw_stock_images_pro_our_features_sec_feature_desc_font_size != false || $vw_stock_images_pro_our_features_sec_feature_desc_font_weight != false) {
	$custom_css .= 'p.feature-text{';
	if ($vw_stock_images_pro_our_features_sec_feature_desc_color != false) {
		$custom_css .= 'color: ' . esc_html($vw_stock_images_pro_our_features_sec_feature_desc_color) . ' ;';
	}
	if ($vw_stock_images_pro_our_features_sec_feature_desc_font_family != false) {
		$custom_css .= 'font-family:' . esc_html($vw_stock_images_pro_our_features_sec_feature_desc_font_family) . ' ;';
	}
	if ($vw_stock_images_pro_our_features_sec_feature_desc_font_size != false) {
		$custom_css .= 'font-size:' . esc_html($vw_stock_images_pro_our_features_sec_feature_desc_font_size) . 'px ;';
	}
	if ($vw_stock_images_pro_our_features_sec_feature_desc_font_weight != false) {
		$custom_css .= 'font-weight:' . esc_html($vw_stock_images_pro_our_features_sec_feature_desc_font_weight) . ' ;';
	}
	$custom_css .= '}';
}
