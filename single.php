							...
							<div class="row">
	                            ...
	                            <p class="author-name mb-0 ">
									...
									<div class="single-blog-content">
										<?php the_content(); ?>
								    <h6 class="mb-2 blog-que  ps-lg-2">	<?php echo esc_html(get_post_meta($post->ID,'post-ques',true)); ?></h6>
						        	...
						        	<?php echo esc_html(get_post_meta($post->ID,'post-para-one',true)); ?>
									 ...
									 <div class="row mt-4  ps-lg-2 mb-4">
										 <div class="col-lg-6">
											 <p  class="mb-2">
										 <i class="fas fa-chevron-right pe-2"></i><?php echo esc_html(get_post_meta($post->ID,'post-point-one',true)); ?>
										 	</p>
										 </div>
										 <div class="col-lg-6">
											 <p  class="mb-2 ">
										 <i class="fas fa-chevron-right pe-2"></i><?php echo esc_html(get_post_meta($post->ID,'post-point-two',true)); ?>
										 	</p>
										 </div>
										 <div class="col-lg-6">
											 <p  class="mb-2 ">
							...
							<div class="row justify-content-center mt-3">
									<div class="col-lg-8 col-md-8">
										<?php if(get_theme_mod('vw_stock_images_pro_recent_blog_heading')!=''){ ?>
											<h2 class="main-head  text-center"><?php echo esc_html(get_theme_mod('vw_stock_images_pro_recent_blog_heading')); ?></h2>
										<?php } ?>
										<?php if(get_theme_mod('vw_stock_images_pro_recent_blog_paragraph')!=''){ ?>
											<p class="theme-para  mb-md-0  mb-2  text-center"><?php echo esc_html(get_theme_mod('vw_stock_images_pro_recent_blog_paragraph')); ?></p>
										<?php } ?>
									</div>
