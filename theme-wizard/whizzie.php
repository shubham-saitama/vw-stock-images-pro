...
class ThemeWhizzie {
	...
	public function activation_page() {
		...
		<div class="wrap">
			...
			<form id="vw_stock_images_pro_license_form">
				<input type="text" name="vw_stock_images_pro_license_key" value="<?php echo $theme_key ?>" <?php if($validation_status === 'true') { echo "disabled"; } ?> required placeholder="License Key" />
		...
		<div class="wrap">
			<div class="wizard-logo-wrap">
				...
				<span class="wizard-main-title">
					<?php esc_html_e('Welcome to ','vw-stock-images-pro'); echo $this->theme_title; ?>
				</span>
			</div>
	 ...
	 ?>
		...
		<div class="vw-setup-finish">
			...
			<div class="finish-buttons">
				<a href="<?php echo esc_url(admin_url('/customize.php')); ?>" class="wz-btn-customizer" target="_blank"><?php esc_html_e('Customize Your Demo','vw-stock-images-pro') ?></a>
				<a href="" class="wz-btn-builder" target="_blank"><?php esc_html_e('Customize Your Demo','vw-stock-images-pro'); ?></a>
				<a href="<?php echo esc_url(site_url()); ?>" class="wz-btn-visit-site" target="_blank"><?php esc_html_e('Visit Your Site','vw-stock-images-pro'); ?></a>
			</div>
	...
	$topbar_social_icons = array(
	 ...
	 //Scroll Top
		...
		set_theme_mod('vw_stock_images_pro_slider_heading','Guarding Your Home : Tailored');
		set_theme_mod('vw_stock_images_pro_slider_hightlight_heading',' Pest Control');
		set_theme_mod('vw_stock_images_pro_slider_heading_two','Solutions for Every Need');
		set_theme_mod('vw_stock_images_pro_slider_paragraph',"Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.");
...
$services_categories_array = array();
 ...
 'Commercial' => array('Medical Cleaning', 'Office Cleaning','Industrial Cleaning','School Cleaning',
 'Building Cleaning','Education Centre','Warehouse Cleaning','Factory Cleaning'),
	 ...
	 set_post_thumbnail($services_id, $attach_id);
	    ...
	    set_theme_mod('vw_stock_images_pro_popular_products_btn_url',get_permalink(ThemeWhizzie::get_page_id_by_title('Shop')));
			...
			$k = 0;
			    ...
			    $content = "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce laoreet, ligula condimentum tincidunt, arcu orci laoreet massa, nec sagittis elit urna in diam. Sed consectetur dolor non nulla porttitorLorem ipsum dolor sit amet, consectetur adipiscing elit.
					<ul>
					 	<li>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce laoreet, ligula condimentum tincidunt, arcu orci laoreet massa, nec sagittis elit urna in diam. Sed consectetur dolor non nulla porttitorLorem ipsum dolor sit amet, consectetur adipiscing elit.</li>
					 	<li>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce laoreet, ligula condimentum tincidunt, arcu orci laoreet massa, nec sagittis elit urna in diam</li>
					 	<li>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce laoreet, ligula condimentum tincidunt, arcu orci laoreet massa, nec sagittis elit urna in diam</li>
					 	<li>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce laoreet, ligula condimentum tincidunt, arcu orci laoreet massa, nec sagittis elit urna in diam</li>
					</ul>";

					$product_excerpt = "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce laoreet, ligula condimentum tincidunt, arcu orci laoreet massa, nec sagittis elit urna in diam. Sed consectetur dolor non nulla porttitorLorem ipsum dolor sit amet, consectetur adipiscing elit.";
			    // Create post object
			    $my_post = array(
			    ...
			    for ( $c=0; $c <= 4; $c++ ) {
				 ...
				 $random_price = rand(10,99);
					update_post_meta( $post_id, '_sale_price', $random_price - 10 );
					update_post_meta( $post_id, '_price', $random_price - 10 );
					update_post_meta( $post_id, '_regular_price', $random_price );
					update_comment_meta( $comment_id, 'rating', 5 );

					update_post_meta($post_id, 'shipping-text1', 'Free Delivery');
				 update_post_meta($post_id, 'shipping-text2', 'Top Brand');
				 update_post_meta($post_id, 'shipping-text3', 'Pay On Delivery');
				 update_post_meta($post_id, 'shipping-text4', '10 Day Return & Exchange');

				 update_post_meta($post_id, 'shipping-img1', get_template_directory_uri() . '/assets/images/product/img1.png');
				 update_post_meta($post_id, 'shipping-img2', get_template_directory_uri() . '/assets/images/product/img2.png');
				 update_post_meta($post_id, 'shipping-img3', get_template_directory_uri() . '/assets/images/product/img3.png');
				 update_post_meta($post_id, 'shipping-img4', get_template_directory_uri() . '/assets/images/product/img4.png');
				 	add_post_meta( $post_id, 'vw_title_banner_image_wp_custom_attachment', $banner_attachment_url );
			...
			set_theme_mod( 'vw_stock_images_pro_faq_number', '5' );
				$faqque = array("What should I expect on my first appointment?",
	...
	public function vw_stock_images_pro_mostrar_guide() {
		...
		<div class="wrapper-info get-stared-page-wrap">
			...
			<div class="wrapper-info-content">
				<h2><?php _e( 'Welcome to VW Stock Images', 'vw-stock-images-pro' ); ?> <span class="version">Version: <?php echo esc_html($theme['Version']);?></span></h2>
				<p><?php _e('All our WordPress themes are modern, minimalist, 100% responsive, seo-friendly,feature-rich, block based and multipurpose that best suit designers, bloggers and other professionals who are working in the creative fields.','vw-stock-images-pro'); ?></p>
			</div>
			<div class="tab-sec theme-option-tab">
				<div class="tab">
					<button class="tablinks active" onclick="openCity(event, 'theme_activation')" data-tab="theme_activation"><?php _e( 'Key Activation', 'vw-stock-images-pro' ); ?></button>
					<button class="tablinks wizard-tab" onclick="openCity(event, 'demo_offer')" data-tab="demo_offer"><?php _e( 'Setup Wizard', 'vw-stock-images-pro' ); ?></button>
					<button class="tablinks" onclick="openCity(event, 'theme_info')" data-tab="theme_info"><?php _e( 'Support', 'vw-stock-images-pro' ); ?></button>
					<button class="tablinks" onclick="openCity(event, 'plugins')" data-tab="plugins"><?php _e( 'Plugins', 'vw-stock-images-pro' ); ?></button>
					<button class="tablinks other-product-tab" onclick="openCity(event, 'others_theme')"><?php esc_html_e( 'All Themes', 'vw-stock-images-pro' ); ?></button>
				</div>
				...
				<div id="theme_info" class="tabcontent">
					<div class="col-left-inner">
						...
						<p><?php _e( 'If you need any assistance regarding setting up and configuring the Theme, our documentation is there.', 'vw-stock-images-pro' ); ?></p>
						<div class="info-link">
							<a href="<?php echo esc_url( vw_stock_images_pro_THEME_DOC ); ?>" target="_blank"> <?php _e( 'Documentation', 'vw-stock-images-pro' ); ?></a>
						</div>
						<hr>
						<h4><?php _e('Having Trouble, Need Support?', 'vw-stock-images-pro'); ?></h4>
						<p> <?php _e('Our dedicated team is well prepared to help you out in case of queries and doubts regarding our theme.', 'vw-stock-images-pro'); ?></p>
						<div class="info-link">
							<a href="<?php echo esc_url( vw_stock_images_pro_SUPPORT ); ?>" target="_blank"><?php _e('Support Forum', 'vw-stock-images-pro'); ?></a>
						</div>
						<hr>
						<h4><?php _e('Reviews & Testimonials', 'vw-stock-images-pro'); ?></h4>
						<p> <?php _e('All the features and aspects of this WordPress Theme are phenomenal. I\'d recommend this theme to all.', 'vw-stock-images-pro'); ?>  </p>
						<div class="info-link">
							<a href="<?php echo esc_url( vw_stock_images_pro_REVIEW ); ?>" target="_blank"><?php _e('Reviews', 'vw-stock-images-pro'); ?></a>
						</div>
					</div>
					<div class="col-right-inner">
						<div id="vw-demo-setup-guid">
							<h3><?php esc_html_e('Checkout our setup videos','vw-stock-images-pro'); ?></h3><hr />
					<ul>
								<li>
