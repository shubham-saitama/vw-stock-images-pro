...
$vw_stock_images_pro_config['page_slug'] 	= 'vw-stock-images-pro';
$vw_stock_images_pro_config['page_title']	= 'Get Started';
...
$vw_stock_images_pro_config['steps'] = array( 
	'intro' => array(
		'id'			=> 'intro', // ID for section - don't rename
		'title'			=> __( 'Welcome to ', 'vw-stock-images-pro' ) . $theme_title, // Section title
		'icon'			=> 'dashboard', // Uses Dashicons
		'button_text'	=> __( 'Start Now', 'vw-stock-images-pro' ), // Button text
	...
	'widgets' => array(
		'id'			=> 'widgets',
		'title'			=> __( 'Demo Importer', 'vw-stock-images-pro' ),
...
if( class_exists( 'ThemeWhizzie' ) ) {
	$ThemeWhizzie = new ThemeWhizzie( $vw_stock_images_pro_config );
}