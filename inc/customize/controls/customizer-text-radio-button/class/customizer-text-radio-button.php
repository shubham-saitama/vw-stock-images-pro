 ...
 */
 class vw_stock_images_pro_Text_Radio_Button_Custom_Control extends WP_Customize_Control {
		/**
 ...
 */
if ( ! function_exists( 'vw_stock_images_pro_text_sanitization' ) ) {
	function vw_stock_images_pro_text_sanitization( $input ) {
