<?php
	...
	class vw_stock_images_pro_Slider_Custom_Control extends WP_Customize_Control {
		/**
	...
	function vw_stock_images_pro_slider_line_script() {
	...
	add_action( 'customize_controls_enqueue_scripts', 'vw_stock_images_pro_slider_line_script' );
