...
$wp_customize->add_setting( 'vw_stock_images_pro_about_section_content_color_typoghraphy',
  array(
    'default' => '',
    'transport' => 'postMessage',
    'sanitize_callback' => 'vw_stock_images_pro_text_sanitization'
));
$wp_customize->add_control( new VW_Themes_Seperator_custom_Control( $wp_customize, 'vw_stock_images_pro_about_section_content_color_typoghraphy',
array(
...
$wp_customize->add_control(
  'vw_stock_images_pro_about_section_mission_heading_font_family', array(
  'section'  => 'vw_stock_images_pro_about_page',
...
$wp_customize->add_control(
  'vw_stock_images_pro_about_section_mission_para_font_family', array(
  'section'  => 'vw_stock_images_pro_about_page',
...
$wp_customize->add_control(
  'vw_stock_images_pro_support_page_heading_font_family', array(
  'section'  => 'vw_stock_images_pro_support_page',
  'label'    => __( 'Heading Font Family','vw-stock-images-pro'),
  'type'     => 'select',
  'choices'  => $font_array
...
$wp_customize->add_control(
  'vw_stock_images_pro_support_page_sub_heading_font_family', array(
  'section'  => 'vw_stock_images_pro_support_page',
...
$wp_customize->add_control(
  'vw_stock_images_pro_support_page_para_font_family', array(
  'section'  => 'vw_stock_images_pro_support_page',
...
$wp_customize->add_control(
  'vw_stock_images_pro_category_page_heading_font_family', array(
  'section'  => 'vw_stock_images_pro_category_page',
  'label'    => __( 'Heading Font Family','vw-stock-images-pro'),
  'type'     => 'select',
  'choices'  => $font_array
...
$wp_customize->add_control(
  'vw_stock_images_pro_category_page_para_font_family', array(
  'section'  => 'vw_stock_images_pro_category_page',
  'label'    => __( 'Paragraph Font Family','vw-stock-images-pro'),
  'type'     => 'select',
  'choices'  => $font_array
...
$wp_customize->add_control(
  'vw_stock_images_pro_category_page_sub_heading_font_family', array(
  'section'  => 'vw_stock_images_pro_category_page',
  'label'    => __( 'Sub Heading Font Family','vw-stock-images-pro'),
  'type'     => 'select',
  'choices'  => $font_array
...
$wp_customize->add_control(
  'vw_stock_images_pro_category_page_points_font_family', array(
  'section'  => 'vw_stock_images_pro_category_page',
...
$wp_customize->add_setting( 'vw_stock_images_pro_category_page_category_tab_setting',
  array(
    'default' => '',
    'transport' => 'postMessage',
    'sanitize_callback' => 'vw_stock_images_pro_text_sanitization'
));
$wp_customize->add_control( new VW_Themes_Seperator_custom_Control( $wp_customize, 'vw_stock_images_pro_category_page_category_tab_setting',
array(
...
$wp_customize->add_control(
  'vw_stock_images_pro_category_page_category_tab_category_font_family', array(
  'section'  => 'vw_stock_images_pro_category_page',
...
$wp_customize->add_control(
  'vw_stock_images_pro_category_page_category_name_font_family', array(
  'section'  => 'vw_stock_images_pro_category_page',
...
$wp_customize->add_control(
  'vw_stock_images_pro_category_page_category_main_heading_font_family', array(
  'section'  => 'vw_stock_images_pro_category_page',
...
$wp_customize->add_control(
  'vw_stock_images_pro_category_page_category_main_sub_heading_font_family', array(
  'section'  => 'vw_stock_images_pro_category_page',
...
$wp_customize->add_control(
  'vw_stock_images_pro_category_page_category_main_content_font_family', array(
  'section'  => 'vw_stock_images_pro_category_page',
...
$wp_customize->add_control(
	'vw_stock_images_pro_category_page_category_btn_font_family', array(
	'section'  => 'vw_stock_images_pro_category_page',
...
$wp_customize->add_setting( 'vw_stock_images_pro_lacation_page_main_map_setting',
  array(
    'default' => '',
    'transport' => 'postMessage',
    'sanitize_callback' => 'vw_stock_images_pro_text_sanitization'
));
  $wp_customize->add_control( new VW_Themes_Seperator_custom_Control( $wp_customize, 'vw_stock_images_pro_lacation_page_main_map_setting',
  array(
  ...
  $wp_customize->add_setting( 'vw_stock_images_pro_lacation_page_card_setting',
    array(
      'default' => '',
      'transport' => 'postMessage',
      'sanitize_callback' => 'vw_stock_images_pro_text_sanitization'
  ));
    $wp_customize->add_control( new VW_Themes_Seperator_custom_Control( $wp_customize, 'vw_stock_images_pro_lacation_page_card_setting',
    array(
    ...
    for ($i=1; $i <= $no_cards ; $i++) {
      $wp_customize->add_setting( 'vvw_stock_images_pro_location_number_settings'.$i,
      array(
        'default' => '',
        'transport' => 'postMessage',
        'sanitize_callback' => 'vw_stock_images_pro_text_sanitization'
      ));
      $wp_customize->add_control( new VW_Themes_Seperator_custom_Control( $wp_customize, 'vvw_stock_images_pro_location_number_settings'.$i,
      array(
    ...
    $wp_customize->add_control(
    	'vw_stock_images_pro_location_name_font_family', array(
    	'section'  => 'vw_stock_images_pro_lacation_page',
    ...
    $wp_customize->add_control(
    	'vw_stock_images_pro_location_address_font_family', array(
    	'section'  => 'vw_stock_images_pro_lacation_page',
    ...
    $wp_customize->add_control(
    	'vw_stock_images_pro_location_number_font_family', array(
    	'section'  => 'vw_stock_images_pro_lacation_page',
    ...
    $wp_customize->add_control(
    	'vw_stock_images_pro_location_btn_font_family', array(
    	'section'  => 'vw_stock_images_pro_lacation_page',
    ...
    $wp_customize->add_control(
    	'vw_stock_images_pro_appoinment_form_heading_font_family', array(
    	'section'  => 'vw_stock_images_pro_appoinment_page',
    	'label'    => __( 'Heading Font Family','vw-stock-images-pro'),
    	'type'     => 'select',
    	'choices'  => $font_array
    ...
    $wp_customize->add_control(
      'vw_stock_images_pro_appoinment_form_btn_font_family', array(
      'section'  => 'vw_stock_images_pro_appoinment_page',
      'label'    => __( 'Button Font Family','vw-stock-images-pro'),
      'type'     => 'select',
      'choices'  => $font_array
...
$wp_customize->add_control(
	'vw_stock_images_pro_terms_condition_page_heading_font_family', array(
	'section'  => 'vw_stock_images_pro_terms_condition_page',
	'label'    => __( 'Heading Font Family','vw-stock-images-pro'),
	'type'     => 'select',
	'choices'  => $font_array
...
$wp_customize->add_control(
	'vw_stock_images_pro_terms_condition_page_para_font_family', array(
	'section'  => 'vw_stock_images_pro_terms_condition_page',
...
$wp_customize->add_control(
	'vw_stock_images_pro_privacy_policy_page_heading_font_family', array(
	'section'  => 'vw_stock_images_pro_privacy_policy_page',
...
$wp_customize->add_control(
	'vw_stock_images_pro_privacy_policy_page_para_font_family', array(
	'section'  => 'vw_stock_images_pro_privacy_policy_page',
	'label'    => __( 'Paragraph Color Font Family','vw-stock-images-pro'),
	'type'     => 'select',
	'choices'  => $font_array
  ...
  $wp_customize->add_section('vw_stock_images_pro_single_product_page',array(
    'title' => __('Single Product Page Setting','vw-stock-images-pro'),
    'panel' => 'vw_stock_images_pro_panel_id',
  ));
  ...
  $wp_customize->add_control('product_helpline_fields',array(
    ...
    'section'=> 'vw_stock_images_pro_single_product_page',
    'type'=> 'text'
  ));
...
//404 Page Setting
 ...
 $wp_customize->add_control(
     new WP_Customize_Image_Control($wp_customize,'vw_stock_images_pro_404_page_bgimage',
         array(
 ...
 $wp_customize->add_control(
     new WP_Customize_Image_Control($wp_customize,'vw_stock_images_pro_error_temp_bg_images',
         array(
         'label' => __('404 Image','vw-stock-images-pro'),
         'section' => 'vw_stock_images_pro_404_page',
         'settings' => 'vw_stock_images_pro_error_temp_bg_images'
 )));
 $wp_customize->add_setting( 'vw_stock_images_pro_404_page_color_settings',
 array(
   'default' => '',
   'transport' => 'postMessage',
   'sanitize_callback' => 'vw_stock_images_pro_text_sanitization'
 ));
 $wp_customize->add_control( new VW_Themes_Seperator_custom_Control( $wp_customize, 'vw_stock_images_pro_404_page_color_settings',
 array(
 ...
 $wp_customize->add_control(
   'vw_stock_images_pro_404_page_title_font_family', array(
   'section'  => 'vw_stock_images_pro_404_page',
   'label'    => __( 'Heading Font Family','vw-stock-images-pro'),
   'type'     => 'select',
   'choices'  => $font_array
 ...
 $wp_customize->add_control(
   'vw_stock_images_pro_404_page_content_font_family', array(
   'section'  => 'vw_stock_images_pro_404_page',
   'label'    => __( 'Content Font Family','vw-stock-images-pro'),
   'type'     => 'select',
   'choices'  => $font_array
 ...
 $wp_customize->add_setting( 'vw_stock_images_pro_404_page_button_settings',
 array(
   'default' => '',
   'transport' => 'postMessage',
   'sanitize_callback' => 'vw_stock_images_pro_text_sanitization'
 ));
 $wp_customize->add_control( new VW_Themes_Seperator_custom_Control( $wp_customize, 'vw_stock_images_pro_404_page_button_settings',
 array(
 ...
 $wp_customize->add_control(
   'vw_stock_images_pro_404_page_button_font_family', array(
   'section'  => 'vw_stock_images_pro_404_page',
   'label'    => __( 'Button Font Family','vw-stock-images-pro'),
   'type'     => 'select',
   'choices'  => $font_array
