...
$wp_customize->add_setting('vw_stock_images_pro_pests_problem_enable',
		array(
				'default' => 'Enable',
				'sanitize_callback' => 'vw_stock_images_pro_sanitize_choices'
));
$wp_customize->add_control('vw_stock_images_pro_pests_problem_enable',
		array(
				'type' => 'radio',
...
$wp_customize->add_setting( 'vw_stock_images_pro_pests_problem_section_settings',
array(
	'default' => '',
	'transport' => 'postMessage',
	'sanitize_callback' => 'vw_stock_images_pro_text_sanitization'
));
$wp_customize->add_control( new VW_Themes_Seperator_custom_Control( $wp_customize, 'vw_stock_images_pro_pests_problem_section_settings',
array(
...
$wp_customize->add_setting( 'vw_stock_images_pro_pests_problem_section_color_font_settings',
array(
	'default' => '',
	'transport' => 'postMessage',
	'sanitize_callback' => 'vw_stock_images_pro_text_sanitization'
));
$wp_customize->add_control( new VW_Themes_Seperator_custom_Control( $wp_customize, 'vw_stock_images_pro_pests_problem_section_color_font_settings',
array(
...
$wp_customize->add_control(
	'vw_stock_images_pro_pests_problem_heading_font_family', array(
	'section'  => 'vw_stock_images_pro_pest_problem_sec',
...
$wp_customize->add_control(
	'vw_stock_images_pro_pests_problem_paragraph_font_family', array(
	'section'  => 'vw_stock_images_pro_pest_problem_sec',
...
$wp_customize->add_control(
	'vw_stock_images_pro_pests_problem_btn_font_family', array(
	'section'  => 'vw_stock_images_pro_pest_problem_sec',
...
$wp_customize->add_setting( 'vw_stock_images_pro_pests_problem_card_color_font_settings',
array(
	'default' => '',
	'transport' => 'postMessage',
	'sanitize_callback' => 'vw_stock_images_pro_text_sanitization'
));
$wp_customize->add_control( new VW_Themes_Seperator_custom_Control( $wp_customize, 'vw_stock_images_pro_pests_problem_card_color_font_settings',
array(
...
$wp_customize->add_control(
	'vw_stock_images_pro_pests_problem_card_heading_font_family', array(
	'section'  => 'vw_stock_images_pro_pest_problem_sec',
...
$wp_customize->add_control(
	'vw_stock_images_pro_pests_problem_card_paragraph_font_family', array(
	'section'  => 'vw_stock_images_pro_pest_problem_sec',
...
'settings' => 'vw_stock_images_pro_pests_problem_owl_dots_active_color',
	...
	$wp_customize->add_setting('vw_stock_images_pro_about_enable',
			array(
					'default' => 'Enable',
					'sanitize_callback' => 'vw_stock_images_pro_sanitize_choices'
	));
	$wp_customize->add_control('vw_stock_images_pro_about_enable',
			array(
					'type' => 'radio',
					'label' => __('Do you want this section', 'vw-stock-images-pro'),
	...
	$wp_customize->add_setting( 'vw_stock_images_pro_about_section_settings',
	array(
		'default' => '',
		'transport' => 'postMessage',
		'sanitize_callback' => 'vw_stock_images_pro_text_sanitization'
	));
	$wp_customize->add_control( new VW_Themes_Seperator_custom_Control( $wp_customize, 'vw_stock_images_pro_about_section_settings',
	array(
		'label' => __('Section Typoghraphy','vw-stock-images-pro'),
		'section' => 'vw_stock_images_pro_about_sec	'
	)));
  ...
  $wp_customize->add_control('vw_stock_images_pro_about_year_text',array(
	...
	$wp_customize->add_setting('vw_stock_images_pro_about_phone_icon',
		array(
				'default'     => get_theme_mod('vw_stock_images_pro_about_phone_icon'),
				'sanitize_callback' => 'sanitize_text_field'
			)
	);
	$wp_customize->add_control(new vw_stock_images_pro_Fontawesome_Icon_Chooser(	$wp_customize,	'vw_stock_images_pro_about_phone_icon',	array(
  ...
  $wp_customize->add_control('vw_stock_images_pro_about_emergency_number',array(
	...
	$wp_customize->add_setting( 'vw_stock_images_pro_about_color_font_settings',
	array(
		'default' => '',
		'transport' => 'postMessage',
		'sanitize_callback' => 'vw_stock_images_pro_text_sanitization'
	));
	$wp_customize->add_control( new VW_Themes_Seperator_custom_Control( $wp_customize, 'vw_stock_images_pro_about_color_font_settings',
	array(
		'label' => __('Section Color & font Setting','vw-stock-images-pro'),
		'section' => 'vw_stock_images_pro_about_sec'
	)));
	...
	$wp_customize->add_control(
		'vw_stock_images_pro_about_heading_font_family', array(
		'section'  => 'vw_stock_images_pro_about_sec',
		'label'    => __( 'Heading Font Family','vw-stock-images-pro'),
		'type'     => 'select',
		'choices'  => $font_array
	...
	$wp_customize->add_control(
		'vw_stock_images_pro_about_paragraph_font_family', array(
		'section'  => 'vw_stock_images_pro_about_sec',
		'label'    => __( 'Paragraph Font Family','vw-stock-images-pro'),
		'type'     => 'select',
		'choices'  => $font_array
	...
	$wp_customize->add_control(
		'vw_stock_images_pro_about_inner_heading_font_family', array(
		'section'  => 'vw_stock_images_pro_about_sec',
	...
	$wp_customize->add_control(
		'vw_stock_images_pro_about_inner_paragraph_font_family', array(
		'section'  => 'vw_stock_images_pro_about_sec',
	...
	$wp_customize->add_control(
		'vw_stock_images_pro_about_left_btn_font_family', array(
		'section'  => 'vw_stock_images_pro_about_sec',
		'label'    => __( 'Button Font Family','vw-stock-images-pro'),
		'type'     => 'select',
		'choices'  => $font_array
	...
	$wp_customize->add_control(
		'vw_stock_images_pro_about_manager_font_family', array(
		'section'  => 'vw_stock_images_pro_about_sec',
	...
	$wp_customize->add_control(
		'vw_stock_images_pro_about_manager_text_font_family', array(
		'section'  => 'vw_stock_images_pro_about_sec',
	...
	$wp_customize->add_control(
		'vw_stock_images_pro_about_year_number_font_family', array(
		'section'  => 'vw_stock_images_pro_about_sec',
	...
	$wp_customize->add_control(
		'vw_stock_images_pro_about_year_text_font_family', array(
		'section'  => 'vw_stock_images_pro_about_sec',
	...
	$wp_customize->add_control(
		'vw_stock_images_pro_about_number_font_family', array(
		'section'  => 'vw_stock_images_pro_about_sec',
	...
	$wp_customize->add_control(
		'vw_stock_images_pro_about_emergency_number_font_family', array(
		'section'  => 'vw_stock_images_pro_about_sec',
	...
	$wp_customize->add_setting('vw_stock_images_pro_radio_professional_services_enable',
			array(
					'default' => 'Enable',
					'sanitize_callback' => 'vw_stock_images_pro_sanitize_choices'
	));
	$wp_customize->add_control('vw_stock_images_pro_radio_professional_services_enable',
			array(
					'type' => 'radio',
					'label' => __('Do you want this section', 'vw-stock-images-pro'),
	...
	$wp_customize->add_setting( 'vw_stock_images_pro_professional_services_section_settings',
	array(
		'default' => '',
		'transport' => 'postMessage',
		'sanitize_callback' => 'vw_stock_images_pro_text_sanitization'
	));
	$wp_customize->add_control( new VW_Themes_Seperator_custom_Control( $wp_customize, 'vw_stock_images_pro_professional_services_section_settings',
	array(
		'label' => __('Section Typoghraphy','vw-stock-images-pro'),
		'section' => 'vw_stock_images_pro_professional_services_sec'
	)));
	...
	$wp_customize->add_setting( 'vw_stock_images_pro_professional_services_section_color_font_settings',
	array(
		'default' => '',
		'transport' => 'postMessage',
		'sanitize_callback' => 'vw_stock_images_pro_text_sanitization'
	));
	$wp_customize->add_control( new VW_Themes_Seperator_custom_Control( $wp_customize, 'vw_stock_images_pro_professional_services_section_color_font_settings',
	array(
		'label' => __('Section Color & font Setting','vw-stock-images-pro'),
		'section' => 'vw_stock_images_pro_professional_services_sec'
	)));
	...
	$wp_customize->add_control(
		'vw_stock_images_pro_professional_services_heading_font_family', array(
		'section'  => 'vw_stock_images_pro_professional_services_sec',
		'label'    => __( 'Heading Font Family','vw-stock-images-pro'),
		'type'     => 'select',
		'choices'  => $font_array
	...
	$wp_customize->add_control(
		'vw_stock_images_pro_professional_services_paragraph_font_family', array(
		'section'  => 'vw_stock_images_pro_professional_services_sec',
		'label'    => __( 'Paragraph Font Family','vw-stock-images-pro'),
		'type'     => 'select',
		'choices'  => $font_array
	...
	$wp_customize->add_control(
		'vw_stock_images_pro_professional_services_tab_btn_font_family', array(
		'section'  => 'vw_stock_images_pro_professional_services_sec',
	...
	$wp_customize->add_setting( 'vw_stock_images_pro_professional_services_section_card_color_font_settings',
	array(
		'default' => '',
		'transport' => 'postMessage',
		'sanitize_callback' => 'vw_stock_images_pro_text_sanitization'
	));
	$wp_customize->add_control( new VW_Themes_Seperator_custom_Control( $wp_customize, 'vw_stock_images_pro_professional_services_section_card_color_font_settings',
	array(
		'label' => __('Section Card Color & font Setting','vw-stock-images-pro'),
		'section' => 'vw_stock_images_pro_professional_services_sec'
	)));
	...
	$wp_customize->add_control(
		'vw_stock_images_pro_professional_services_card_heading_font_family', array(
		'section'  => 'vw_stock_images_pro_professional_services_sec',
		'label'    => __( 'Card Heading Font Family','vw-stock-images-pro'),
		'type'     => 'select',
		'choices'  => $font_array
	...
	$wp_customize->add_control(
		'vw_stock_images_pro_professional_services_card_paragraph_font_family', array(
		'section'  => 'vw_stock_images_pro_professional_services_sec',
		'label'    => __( 'Card Paragraph Font Family','vw-stock-images-pro'),
		'type'     => 'select',
		'choices'  => $font_array
	...
	$wp_customize->add_control(
		'vw_stock_images_pro_professional_services_card_btn_font_family', array(
		'section'  => 'vw_stock_images_pro_professional_services_sec',
		'label'    => __( 'Button Font Family','vw-stock-images-pro'),
		'type'     => 'select',
		'choices'  => $font_array
...
$wp_customize->add_setting('vw_stock_images_pro_counter_offer_enable',
		array(
				'default' => 'Enable',
				'sanitize_callback' => 'vw_stock_images_pro_sanitize_choices'
));
$wp_customize->add_control('vw_stock_images_pro_counter_offer_enable',
		array(
				'type' => 'radio',
				'label' => __('Do you want this section', 'vw-stock-images-pro'),
...
$wp_customize->add_setting( 'vw_stock_images_pro_counter_offer_section_settings',
array(
	'default' => '',
	'transport' => 'postMessage',
	'sanitize_callback' => 'vw_stock_images_pro_text_sanitization'
));
$wp_customize->add_control( new VW_Themes_Seperator_custom_Control( $wp_customize, 'vw_stock_images_pro_counter_offer_section_settings',
array(
	'label' => __('Section Typoghraphy','vw-stock-images-pro'),
	'section' => 'vw_stock_images_pro_counter_offer_sec'
)));
...
$wp_customize->add_setting( 'vw_stock_images_pro_counter_offer_section_color_font_settings',
array(
	'default' => '',
	'transport' => 'postMessage',
	'sanitize_callback' => 'vw_stock_images_pro_text_sanitization'
));
$wp_customize->add_control( new VW_Themes_Seperator_custom_Control( $wp_customize, 'vw_stock_images_pro_counter_offer_section_color_font_settings',
array(
	'label' => __('Section Color & Font Setting','vw-stock-images-pro'),
	'section' => 'vw_stock_images_pro_counter_offer_sec'
)));
...
$wp_customize->add_control(
	'vw_stock_images_pro_counter_offer_heading_font_family', array(
	'section'  => 'vw_stock_images_pro_counter_offer_sec',
	'label'    => __( 'Heading Font Family','vw-stock-images-pro'),
	'type'     => 'select',
	'choices'  => $font_array
...
$wp_customize->add_control(
	'vw_stock_images_pro_counter_offer_paragraph_font_family', array(
	'section'  => 'vw_stock_images_pro_counter_offer_sec',
	'label'    => __( 'Paragraph Font Family','vw-stock-images-pro'),
	'type'     => 'select',
	'choices'  => $font_array
...
$wp_customize->add_control(
	'vw_stock_images_pro_counter_offer_btn_font_family', array(
	'section'  => 'vw_stock_images_pro_counter_offer_sec',
	'label'    => __( 'Button Font Family','vw-stock-images-pro'),
	'type'     => 'select',
	'choices'  => $font_array
...
$wp_customize->add_control(
	'vw_stock_images_pro_counter_offer_counter_number_font_family', array(
	'section'  => 'vw_stock_images_pro_counter_offer_sec',
...
$wp_customize->add_control(
	'vw_stock_images_pro_counter_offer_counter_number_text_font_family', array(
	'section'  => 'vw_stock_images_pro_counter_offer_sec',
...
'settings' => 'vw_stock_images_pro_counter_offer_counter_number_bg_color',
	...
	$wp_customize->add_setting('vw_stock_images_pro_why_choose_us_enable',
			array(
					'default' => 'Enable',
					'sanitize_callback' => 'vw_stock_images_pro_sanitize_choices'
	));
	$wp_customize->add_control('vw_stock_images_pro_why_choose_us_enable',
			array(
					'type' => 'radio',
					'label' => __('Do you want this section', 'vw-stock-images-pro'),
	...
	$wp_customize->add_setting( 'vw_stock_images_pro_why_choose_us_settings',
	array(
		'default' => '',
		'transport' => 'postMessage',
		'sanitize_callback' => 'vw_stock_images_pro_text_sanitization'
	));
	$wp_customize->add_control( new VW_Themes_Seperator_custom_Control( $wp_customize, 'vw_stock_images_pro_why_choose_us_settings',
	array(
		'label' => __('Section Typoghraphy','vw-stock-images-pro'),
		'section' => 'vw_stock_images_pro_why_choose_us_sec'
	)));
	...
	for ($i=1; $i <= $no_cards ; $i++) {
		$wp_customize->add_setting( 'vw_stock_images_pro_education_register_counter_number_settings'.$i,
		array(
			'default' => '',
			'transport' => 'postMessage',
			'sanitize_callback' => 'vw_stock_images_pro_text_sanitization'
		));
		$wp_customize->add_control( new VW_Themes_Seperator_custom_Control( $wp_customize, 'vw_stock_images_pro_education_register_counter_number_settings'.$i,
		array(
...
$wp_customize->add_setting('vw_stock_images_pro_why_choose_video_play_icon',
	array(
			'default'     => get_theme_mod('vw_stock_images_pro_why_choose_video_play_icon'),
			'sanitize_callback' => 'sanitize_text_field'
		)
);
$wp_customize->add_control(new vw_stock_images_pro_Fontawesome_Icon_Chooser(	$wp_customize,	'vw_stock_images_pro_why_choose_video_play_icon',	array(
...
$wp_customize->add_setting( 'vw_stock_images_pro_why_choose_us_color_font_settings',
array(
	'default' => '',
	'transport' => 'postMessage',
	'sanitize_callback' => 'vw_stock_images_pro_text_sanitization'
));
$wp_customize->add_control( new VW_Themes_Seperator_custom_Control( $wp_customize, 'vw_stock_images_pro_why_choose_us_color_font_settings',
array(
	'label' => __('Section Color & Font Setting','vw-stock-images-pro'),
	'section' => 'vw_stock_images_pro_why_choose_us_sec'
)));
...
$wp_customize->add_control(
	'vw_stock_images_pro_why_choose_heading_font_family', array(
	'section'  => 'vw_stock_images_pro_why_choose_us_sec',
	'label'    => __( 'Heading Font Family','vw-stock-images-pro'),
	'type'     => 'select',
	'choices'  => $font_array
...
$wp_customize->add_control(
	'vw_stock_images_pro_why_choose_para_font_family', array(
	'section'  => 'vw_stock_images_pro_why_choose_us_sec',
	'label'    => __( 'Paragraph Font Family','vw-stock-images-pro'),
	'type'     => 'select',
	'choices'  => $font_array
...
$wp_customize->add_control(
	'vw_stock_images_pro_why_choose_points_font_family', array(
	'section'  => 'vw_stock_images_pro_why_choose_us_sec',
...
'settings' => 'vw_stock_images_pro_why_choose_video_play_icon_background_color',
	...
	$wp_customize->add_setting('vw_stock_images_pro_counter_enable',
			array(
					'default' => 'Enable',
					'sanitize_callback' => 'vw_stock_images_pro_sanitize_choices'
	));
	$wp_customize->add_control('vw_stock_images_pro_counter_enable',
			array(
					'type' => 'radio',
					'label' => __('Do you want this section', 'vw-stock-images-pro'),
	...
	$wp_customize->add_setting( 'vw_stock_images_pro_counter_section_settings',
	array(
		'default' => '',
		'transport' => 'postMessage',
		'sanitize_callback' => 'vw_stock_images_pro_text_sanitization'
	));
	$wp_customize->add_control( new VW_Themes_Seperator_custom_Control( $wp_customize, 'vw_stock_images_pro_counter_section_settings',
	array(
		'label' => __('Section Typoghraphy','vw-stock-images-pro'),
		'section' => 'vw_stock_images_pro_counter_sec'
	)));
	...
	for ($i=1; $i <= $no_cards ; $i++) {
		$wp_customize->add_setting( 'vw_stock_images_pro_counter_card_settings'.$i,
		array(
			'default' => '',
			'transport' => 'postMessage',
			'sanitize_callback' => 'vw_stock_images_pro_text_sanitization'
		));
		$wp_customize->add_control( new VW_Themes_Seperator_custom_Control( $wp_customize, 'vw_stock_images_pro_counter_card_settings'.$i,
		array(
...
$wp_customize->add_setting( 'vw_stock_images_pro_counter_section_color_font_settings',
array(
	'default' => '',
	'transport' => 'postMessage',
	'sanitize_callback' => 'vw_stock_images_pro_text_sanitization'
));
$wp_customize->add_control( new VW_Themes_Seperator_custom_Control( $wp_customize, 'vw_stock_images_pro_counter_section_color_font_settings',
array(
	'label' => __('Section Color & Font setting','vw-stock-images-pro'),
	'section' => 'vw_stock_images_pro_counter_sec'
)));
...
$wp_customize->add_control(
	'vw_stock_images_pro_counter_no_font_family', array(
	'section'  => 'vw_stock_images_pro_counter_sec',
	'label'    => __( 'Counter Number Font Family','vw-stock-images-pro'),
	'type'     => 'select',
	'choices'  => $font_array
...
$wp_customize->add_control(
	'vw_stock_images_pro_counter_title_font_family', array(
	'section'  => 'vw_stock_images_pro_counter_sec',
...
$wp_customize->add_setting('vw_stock_images_pro_popular_products_enable',
		array(
				'default' => 'Enable',
				'sanitize_callback' => 'vw_stock_images_pro_sanitize_choices'
));
$wp_customize->add_control('vw_stock_images_pro_popular_products_enable',
		array(
				'type' => 'radio',
				'label' => __('Do you want this section', 'vw-stock-images-pro'),
...
$wp_customize->add_setting( 'vw_stock_images_pro_popular_products_section_settings',
array(
	'default' => '',
	'transport' => 'postMessage',
	'sanitize_callback' => 'vw_stock_images_pro_text_sanitization'
));
$wp_customize->add_control( new VW_Themes_Seperator_custom_Control( $wp_customize, 'vw_stock_images_pro_popular_products_section_settings',
array(
	'label' => __('Section Typoghraphy','vw-stock-images-pro'),
	'section' => 'vw_stock_images_pro_popular_product_sec'
)));
...
$wp_customize->add_setting( 'vw_stock_images_pro_popular_products_color_font_settings',
array(
	'default' => '',
	'transport' => 'postMessage',
	'sanitize_callback' => 'vw_stock_images_pro_text_sanitization'
));
$wp_customize->add_control( new VW_Themes_Seperator_custom_Control( $wp_customize, 'vw_stock_images_pro_popular_products_color_font_settings',
array(
	'label' => __('Section Color & Font Setting','vw-stock-images-pro'),
	'section' => 'vw_stock_images_pro_popular_product_sec'
)));
...
$wp_customize->add_control(
	'vw_stock_images_pro_section_popular_products_heading_font_family', array(
	'section'  => 'vw_stock_images_pro_popular_product_sec',
	'label'    => __( 'Heading Font Family','vw-stock-images-pro'),
	'type'     => 'select',
	'choices'  => $font_array
...
$wp_customize->add_control(
	'vw_stock_images_pro_section_popular_products_paragraph_font_family', array(
	'section'  => 'vw_stock_images_pro_popular_product_sec',
	'label'    => __( 'Paragraph Font Family','vw-stock-images-pro'),
	'type'     => 'select',
	'choices'  => $font_array
...
$wp_customize->add_control(
	'vw_stock_images_pro_popular_products_btn_font_family', array(
	'section'  => 'vw_stock_images_pro_popular_product_sec',
	'label'    => __( 'Button Font Family','vw-stock-images-pro'),
	'type'     => 'select',
	'choices'  => $font_array
...
$wp_customize->add_setting( 'vw_stock_images_pro_popular_products_card_settings',
array(
	'default' => '',
	'transport' => 'postMessage',
	'sanitize_callback' => 'vw_stock_images_pro_text_sanitization'
));
$wp_customize->add_control( new VW_Themes_Seperator_custom_Control( $wp_customize, 'vw_stock_images_pro_popular_products_card_settings',
array(
...
$wp_customize->add_control(
	'vw_stock_images_pro_section_popular_products_cards_heading_font_family', array(
	'section'  => 'vw_stock_images_pro_popular_product_sec',
...
$wp_customize->add_control(
	'vw_stock_images_pro_section_popular_products_cards_paragraph_font_family', array(
	'section'  => 'vw_stock_images_pro_popular_product_sec',
...
$wp_customize->add_control(
	'vw_stock_images_pro_popular_products_regular_price_font_family', array(
	'section'  => 'vw_stock_images_pro_popular_product_sec',
...
$wp_customize->add_control(
	'vw_stock_images_pro_popular_products_sale_price_font_family', array(
	'section'  => 'vw_stock_images_pro_popular_product_sec',
...
'settings' => 'vw_stock_images_pro_popular_products_icon_bg_color',
	...
	$wp_customize->add_setting('vw_stock_images_pro_faq_enable',
			array(
					'default' => 'Enable',
					'sanitize_callback' => 'vw_stock_images_pro_sanitize_choices'
	));
	$wp_customize->add_control('vw_stock_images_pro_faq_enable',
			array(
					'type' => 'radio',
					'label' => __('Do you want this section', 'vw-stock-images-pro'),
	...
	$wp_customize->add_setting( 'vw_stock_images_pro_faq_section_settings',
	array(
		'default' => '',
		'transport' => 'postMessage',
		'sanitize_callback' => 'vw_stock_images_pro_text_sanitization'
	));
	$wp_customize->add_control( new VW_Themes_Seperator_custom_Control( $wp_customize, 'vw_stock_images_pro_faq_section_settings',
	array(
		'label' => __('Section Typoghraphy','vw-stock-images-pro'),
		'section' => 'vw_stock_images_pro_faq_sec'
	)));
	...
	for ($i=1; $i <= $no_cards ; $i++) {
		$wp_customize->add_setting( 'vw_stock_images_pro_faq_number_settings'.$i,
		array(
			'default' => '',
			'transport' => 'postMessage',
			'sanitize_callback' => 'vw_stock_images_pro_text_sanitization'
		));
		$wp_customize->add_control( new VW_Themes_Seperator_custom_Control( $wp_customize, 'vw_stock_images_pro_faq_number_settings'.$i,
		array(
	...
	$wp_customize->add_setting( 'vw_stock_images_pro_faq_section_color_font_settings',
	array(
		'default' => '',
		'transport' => 'postMessage',
		'sanitize_callback' => 'vw_stock_images_pro_text_sanitization'
	));
	$wp_customize->add_control( new VW_Themes_Seperator_custom_Control( $wp_customize, 'vw_stock_images_pro_faq_section_color_font_settings',
	array(
		'label' => __('Section Color & Font Setting','vw-stock-images-pro'),
		'section' => 'vw_stock_images_pro_faq_sec'
	)));
	...
	$wp_customize->add_control(
	 'vw_stock_images_pro_faq_heading_font_family', array(
	 'section'  => 'vw_stock_images_pro_faq_sec',
	 'label'    => __( 'Heading Font Family','vw-stock-images-pro'),
	 'type'     => 'select',
	 'choices'  => $font_array
	...
	$wp_customize->add_control(
	 'vw_stock_images_pro_faq_paragraph_font_family', array(
	 'section'  => 'vw_stock_images_pro_faq_sec',
	 'label'    => __( 'Paragraph Font Family','vw-stock-images-pro'),
	 'type'     => 'select',
	 'choices'  => $font_array
	...
	$wp_customize->add_control(
	 'vw_stock_images_pro_faq_question_font_family', array(
	 'section'  => 'vw_stock_images_pro_faq_sec',
	...
	$wp_customize->add_control(
	 'vw_stock_images_pro_faq_answer_font_family', array(
	 'section'  => 'vw_stock_images_pro_faq_sec',
	...
	$wp_customize->add_control(
	 'vw_stock_images_pro_faq_inner_heading_font_family', array(
	 'section'  => 'vw_stock_images_pro_faq_sec',
	 'label'    => __( 'Inner Heading Font Family','vw-stock-images-pro'),
	 'type'     => 'select',
	 'choices'  => $font_array
	...
	$wp_customize->add_control(
	 'vw_stock_images_pro_faq_inner_paragraph_font_family', array(
	 'section'  => 'vw_stock_images_pro_faq_sec',
	 'label'    => __( 'Inner Paragraph Font Family','vw-stock-images-pro'),
	 'type'     => 'select',
	 'choices'  => $font_array
	...
	$wp_customize->add_control(
	 'vw_stock_images_pro_faq_form_label_font_family', array(
	 'section'  => 'vw_stock_images_pro_faq_sec',
	...
	$wp_customize->add_control(
		'vw_stock_images_pro_faq_btn_font_family', array(
		'section'  => 'vw_stock_images_pro_faq_sec',
	...
	$wp_customize->add_setting('vw_stock_images_pro_radio_newsletter_enable',
			array(
					'default' => 'Enable',
					'sanitize_callback' => 'vw_stock_images_pro_sanitize_choices'
	));
	$wp_customize->add_control('vw_stock_images_pro_radio_newsletter_enable',
			array(
					'type' => 'radio',
					'label' => __('Do you want this section', 'vw-stock-images-pro'),
...
$wp_customize->add_setting( 'vw_stock_images_pro_our_newsletter_section_settings',
array(
	'default' => '',
	'transport' => 'postMessage',
	'sanitize_callback' => 'vw_stock_images_pro_text_sanitization'
));
$wp_customize->add_control( new VW_Themes_Seperator_custom_Control( $wp_customize, 'vw_stock_images_pro_our_newsletter_section_settings',
array(
...
$wp_customize->add_setting( 'vw_stock_images_pro_our_newsletter_section_color_font_settings',
array(
	'default' => '',
	'transport' => 'postMessage',
	'sanitize_callback' => 'vw_stock_images_pro_text_sanitization'
));
$wp_customize->add_control( new VW_Themes_Seperator_custom_Control( $wp_customize, 'vw_stock_images_pro_our_newsletter_section_color_font_settings',
array(
...
$wp_customize->add_control(
	'vw_stock_images_pro_newsletter_heading_font_family', array(
	'section'  => 'vw_stock_images_pro_newsletter_sec',
...
$wp_customize->add_control(
	'vw_stock_images_pro_newsletter_paragraph_font_family', array(
	'section'  => 'vw_stock_images_pro_newsletter_sec',
...
$wp_customize->add_control(
	'vw_stock_images_pro_our_newsletter_form_btn_font_family', array(
	'section'  => 'vw_stock_images_pro_newsletter_sec',
...
$wp_customize->add_setting( 'vw_stock_images_pro_our_appoinment_section_color_font_settings',
array(
	'default' => '',
	'transport' => 'postMessage',
	'sanitize_callback' => 'vw_stock_images_pro_text_sanitization'
));
$wp_customize->add_control( new VW_Themes_Seperator_custom_Control( $wp_customize, 'vw_stock_images_pro_our_appoinment_section_color_font_settings',
array(
...
$wp_customize->add_control(
	'vw_stock_images_pro_appoinment_heading_font_family', array(
	'section'  => 'vw_stock_images_pro_newsletter_sec',
...
$wp_customize->add_control(
	'vw_stock_images_pro_appoinment_para_font_family', array(
	'section'  => 'vw_stock_images_pro_newsletter_sec',
...
$wp_customize->add_control(
	'vw_stock_images_pro_our_appoinment_form_btn_font_family', array(
	'section'  => 'vw_stock_images_pro_newsletter_sec',
...
$wp_customize->add_section('vw_stock_images_pro_our_client_sec',array(
	'title'	=> __('Our Client Section','vw-stock-images-pro'),
	'description'	=> __('Add Our Client setting here.','vw-stock-images-pro'),
	'panel' => 'vw_stock_images_pro_panel_id',
));

$wp_customize->add_setting('vw_stock_images_pro_radio_our_client_enable',
		array(
				'default' => 'Enable',
				'sanitize_callback' => 'vw_stock_images_pro_sanitize_choices'
));
$wp_customize->add_control('vw_stock_images_pro_radio_our_client_enable',
		array(
				'type' => 'radio',
				'label' => __('Do you want this section', 'vw-stock-images-pro'),
				'section' => 'vw_stock_images_pro_our_client_sec',
				'choices' => array(
				'Enable' => __('Enable', 'vw-stock-images-pro'),
				'Disable' => __('Disable', 'vw-stock-images-pro')
		),
));
$wp_customize->selective_refresh->add_partial( 'vw_stock_images_pro_radio_our_client_enable', array(
	'selector' => '#our-client .container',
	'render_callback' => 'vw_kids_pro_customize_partial_vw_stock_images_pro_radio_our_client_enable',
));

$wp_customize->add_setting( 'vw_stock_images_pro_our_client_color', array(
'default' => '',
'sanitize_callback'	=> 'sanitize_hex_color'
));
$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'vw_stock_images_pro_our_client_color',array(
'label' => __('Background Color', 'vw-stock-images-pro'),
'description' => __('Either add background color or background image, if you add both background color will be top most priority', 'vw-stock-images-pro'),
'section' => 'vw_stock_images_pro_our_client_sec',
'settings' => 'vw_stock_images_pro_our_client_color',
)));
$wp_customize->add_setting('vw_stock_images_pro_our_client_image',array(
'default'	=> '',
'sanitize_callback'	=> 'esc_url_raw',
));
$wp_customize->add_control(new WP_Customize_Image_Control($wp_customize,'vw_stock_images_pro_our_client_image',array(
		'label' => __('Background image ','vw-stock-images-pro'),
		'section' => 'vw_stock_images_pro_our_client_sec',
		'settings' => 'vw_stock_images_pro_our_client_image'
)));

$wp_customize->add_setting( 'vw_stock_images_pro_our_client_image_bg_attachement', array(
	 'default'         => '',
	 'sanitize_callback' => 'vw_stock_images_pro_sanitize_choices'
));
$wp_customize->add_control('vw_stock_images_pro_our_client_image_bg_attachement', array(
	 'type'      => 'radio',
	 'label'     => __('Choose image option', 'vw-stock-images-pro'),
	 'section'   => 'vw_stock_images_pro_our_client_sec',
	 'choices'   => array(
...
$wp_customize->add_setting( 'vw_stock_images_pro_our_client_section_setting',
array(
	'default' => '',
	'transport' => 'postMessage',
	'sanitize_callback' => 'vw_stock_images_pro_text_sanitization'
...
$wp_customize->add_control( new VW_Themes_Seperator_custom_Control( $wp_customize, 'vw_stock_images_pro_our_client_section_setting',
array(
	'label' => __('Section Typography ','vw-stock-images-pro'),
	'section' => 'vw_stock_images_pro_our_client_sec'
)));

$wp_customize->add_setting('vw_stock_images_pro_our_client_heading',array(
	'default' => '',
	'sanitize_callback' => 'sanitize_text_field'
));
$wp_customize->add_control('vw_stock_images_pro_our_client_heading',array(
	'label' => __('Heading','vw-stock-images-pro'),
	'section' => 'vw_stock_images_pro_our_client_sec',
	'setting' => 'vw_stock_images_pro_our_client_heading',
	'type' => 'text'
));
$wp_customize->add_setting('vw_stock_images_pro_our_client_paragraph',array(
	'default' => '',
	'sanitize_callback' => 'sanitize_text_field'
));
$wp_customize->add_control('vw_stock_images_pro_our_client_paragraph',array(
	'label' => __('Paragraph','vw-stock-images-pro'),
	'section' => 'vw_stock_images_pro_our_client_sec',
	'setting' => 'vw_stock_images_pro_our_client_paragraph',
	'type' => 'text'
));
$wp_customize->add_setting( 'vw_stock_images_pro_our_client_section_color_font_setting',
array(
	'default' => '',
	'transport' => 'postMessage',
	'sanitize_callback' => 'vw_stock_images_pro_text_sanitization'
...
$wp_customize->add_control( new VW_Themes_Seperator_custom_Control( $wp_customize, 'vw_stock_images_pro_our_client_section_color_font_setting',
array(
	'label' => __('Section Color & font Setting ','vw-stock-images-pro'),
	'section' => 'vw_stock_images_pro_our_client_sec'
)));

$wp_customize->add_setting( 'vw_stock_images_pro_our_client_heading_color', array(
	'default' => '',
	'sanitize_callback'	=> 'sanitize_hex_color'
));
$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'vw_stock_images_pro_our_client_heading_color', array(
	'label' => __('Heading Color', 'vw-stock-images-pro'),
	'section' => 'vw_stock_images_pro_our_client_sec',
	'settings' => 'vw_stock_images_pro_our_client_heading_color',
)));
$wp_customize->add_setting('vw_stock_images_pro_our_client_heading_font_family',array(
	'default' => '',
	'capability' => 'edit_theme_options',
	'sanitize_callback' => 'sanitize_text_field'
));
$wp_customize->add_control(
		'vw_stock_images_pro_our_client_heading_font_family', array(
		'section'  => 'vw_stock_images_pro_our_client_sec',
		'label'    => __('Heading Font family','vw-stock-images-pro'),
		'type'     => 'select',
		'choices'  => $font_array,
...
$wp_customize->add_setting('vw_stock_images_pro_our_client_heading_font_size',array(
	'default' => '',
	'sanitize_callback' => 'sanitize_text_field'
));
$wp_customize->add_control('vw_stock_images_pro_our_client_heading_font_size',array(
	'label' => __('Heading Font Size','vw-stock-images-pro'),
	'description' => __('Add font size in px','vw-stock-images-pro'),
	'section' => 'vw_stock_images_pro_our_client_sec',
	'setting' => 'vw_stock_images_pro_our_client_heading_font_size',
	'type'    => 'number'
));
$wp_customize->add_setting( 'vw_stock_images_pro_our_client_paragraph_color', array(
	'default' => '',
	'sanitize_callback'	=> 'sanitize_hex_color'
));
$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'vw_stock_images_pro_our_client_paragraph_color', array(
	'label' => __('Paragraph Color', 'vw-stock-images-pro'),
	'section' => 'vw_stock_images_pro_our_client_sec',
	'settings' => 'vw_stock_images_pro_our_client_paragraph_color',
)));
$wp_customize->add_setting('vw_stock_images_pro_our_client_paragraph_font_family',array(
	'default' => '',
	'capability' => 'edit_theme_options',
	'sanitize_callback' => 'sanitize_text_field'
));
$wp_customize->add_control(
		'vw_stock_images_pro_our_client_paragraph_font_family', array(
		'section'  => 'vw_stock_images_pro_our_client_sec',
		'label'    => __('Paragraph Font family','vw-stock-images-pro'),
		'type'     => 'select',
		'choices'  => $font_array,
...
$wp_customize->add_setting('vw_stock_images_pro_our_client_paragraph_font_size',array(
	'default' => '',
	'sanitize_callback' => 'sanitize_text_field'
));
$wp_customize->add_control('vw_stock_images_pro_our_client_paragraph_font_size',array(
	'label' => __('Paragraph Font Size','vw-stock-images-pro'),
	'description' => __('Add font size in px','vw-stock-images-pro'),
	'section' => 'vw_stock_images_pro_our_client_sec',
	'setting' => 'vw_stock_images_pro_our_client_paragraph_font_size',
	'type'    => 'number'
));

$wp_customize->add_setting( 'vw_stock_images_pro_our_client_reviews_color_font_setting',
array(
	'default' => '',
	'transport' => 'postMessage',
	'sanitize_callback' => 'vw_stock_images_pro_text_sanitization'
...
$wp_customize->add_control( new VW_Themes_Seperator_custom_Control( $wp_customize, 'vw_stock_images_pro_our_client_reviews_color_font_setting',
array(
	'label' => __('Client Review Color & font Setting ','vw-stock-images-pro'),
	'section' => 'vw_stock_images_pro_our_client_sec'
)));
$wp_customize->add_setting( 'vw_stock_images_pro_our_client_review_content_color', array(
	'default' => '',
	'sanitize_callback'	=> 'sanitize_hex_color'
));
$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'vw_stock_images_pro_our_client_review_content_color', array(
	'label' => __('Content Color', 'vw-stock-images-pro'),
	'section' => 'vw_stock_images_pro_our_client_sec',
	'settings' => 'vw_stock_images_pro_our_client_review_content_color',
)));
$wp_customize->add_setting('vw_stock_images_pro_our_client_review_content_font_family',array(
	'default' => '',
	'capability' => 'edit_theme_options',
	'sanitize_callback' => 'sanitize_text_field'
));
$wp_customize->add_control(
		'vw_stock_images_pro_our_client_review_content_font_family', array(
		'section'  => 'vw_stock_images_pro_our_client_sec',
...
$wp_customize->add_setting('vw_stock_images_pro_our_client_review_content_font_size',array(
	'default' => '',
	'sanitize_callback' => 'sanitize_text_field'
));
$wp_customize->add_control('vw_stock_images_pro_our_client_review_content_font_size',array(
	'label' => __('Content Font Size','vw-stock-images-pro'),
	'description' => __('Add font size in px','vw-stock-images-pro'),
	'section' => 'vw_stock_images_pro_our_client_sec',
	'setting' => 'vw_stock_images_pro_our_client_review_content_font_size',
	'type'    => 'number'
));

$wp_customize->add_setting( 'vw_stock_images_pro_our_client_name_color', array(
	'default' => '',
	'sanitize_callback'	=> 'sanitize_hex_color'
));
$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'vw_stock_images_pro_our_client_name_color', array(
	'label' => __('Client name Color', 'vw-stock-images-pro'),
	'section' => 'vw_stock_images_pro_our_client_sec',
	'settings' => 'vw_stock_images_pro_our_client_name_color',
)));
$wp_customize->add_setting('vw_stock_images_pro_our_client_name_font_family',array(
	'default' => '',
	'capability' => 'edit_theme_options',
	'sanitize_callback' => 'sanitize_text_field'
));
$wp_customize->add_control(
		'vw_stock_images_pro_our_client_name_font_family', array(
		'section'  => 'vw_stock_images_pro_our_client_sec',
...
$wp_customize->add_setting('vw_stock_images_pro_our_client_name_font_size',array(
	'default' => '',
	'sanitize_callback' => 'sanitize_text_field'
));
$wp_customize->add_control('vw_stock_images_pro_our_client_name_font_size',array(
	'label' => __('Client name Font Size','vw-stock-images-pro'),
	'description' => __('Add font size in px','vw-stock-images-pro'),
	'section' => 'vw_stock_images_pro_our_client_sec',
	'setting' => 'vw_stock_images_pro_our_client_name_font_size',
	'type'    => 'number'
));
$wp_customize->add_setting( 'vw_stock_images_pro_our_client_desig_color', array(
	'default' => '',
	'sanitize_callback'	=> 'sanitize_hex_color'
));
$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'vw_stock_images_pro_our_client_desig_color', array(
	'label' => __('Client Designation Color', 'vw-stock-images-pro'),
	'section' => 'vw_stock_images_pro_our_client_sec',
	'settings' => 'vw_stock_images_pro_our_client_desig_color',
)));
$wp_customize->add_setting('vw_stock_images_pro_our_client_desig_font_family',array(
	'default' => '',
	'capability' => 'edit_theme_options',
	'sanitize_callback' => 'sanitize_text_field'
));
$wp_customize->add_control(
		'vw_stock_images_pro_our_client_desig_font_family', array(
		'section'  => 'vw_stock_images_pro_our_client_sec',
...
$wp_customize->add_setting('vw_stock_images_pro_our_client_desig_font_size',array(
	'default' => '',
	'sanitize_callback' => 'sanitize_text_field'
));
$wp_customize->add_control('vw_stock_images_pro_our_client_desig_font_size',array(
	'label' => __('Client Designation Font Size','vw-stock-images-pro'),
	'description' => __('Add font size in px','vw-stock-images-pro'),
	'section' => 'vw_stock_images_pro_our_client_sec',
	'setting' => 'vw_stock_images_pro_our_client_desig_font_size',
	'type'    => 'number'
));
$wp_customize->add_setting( 'vw_stock_images_pro_our_client_quote_img_color', array(
	'default' => '',
	'sanitize_callback'	=> 'sanitize_hex_color'
));
$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'vw_stock_images_pro_our_client_quote_img_color', array(
	'label' => __('Left Quote Color', 'vw-stock-images-pro'),
	'section' => 'vw_stock_images_pro_our_client_sec',
	'settings' => 'vw_stock_images_pro_our_client_quote_img_color',
)));
$wp_customize->add_setting( 'vw_stock_images_pro_our_client_quote_bg_color', array(
	'default' => '',
	'sanitize_callback'	=> 'sanitize_hex_color'
));
$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'vw_stock_images_pro_our_client_quote_bg_color', array(
	'label' => __('Quote Background Color', 'vw-stock-images-pro'),
	'section' => 'vw_stock_images_pro_our_client_sec',
	'settings' => 'vw_stock_images_pro_our_client_quote_bg_color',
)));
$wp_customize->add_setting( 'vw_stock_images_pro_our_client_quote_border_color', array(
	'default' => '',
	'sanitize_callback'	=> 'sanitize_hex_color'
));
$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'vw_stock_images_pro_our_client_quote_border_color', array(
	'label' => __('Quote Border Color', 'vw-stock-images-pro'),
	'section' => 'vw_stock_images_pro_our_client_sec',
	'settings' => 'vw_stock_images_pro_our_client_quote_border_color',
)));

$wp_customize->add_setting( 'vw_stock_images_pro_our_client_owl_dots_color', array(
'default' => '',
'sanitize_callback'	=> 'sanitize_hex_color'
));
$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'vw_stock_images_pro_our_client_owl_dots_color',array(
'label' => __('Dots Color', 'vw-stock-images-pro'),
'section' => 'vw_stock_images_pro_our_client_sec',
'settings' => 'vw_stock_images_pro_our_client_owl_dots_color',
)));
$wp_customize->add_setting( 'vw_stock_images_pro_our_client_owl_dots_active_color', array(
'default' => '',
'sanitize_callback'	=> 'sanitize_hex_color'
));
$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'vw_stock_images_pro_our_client_owl_dots_active_color',array(
'label' => __('Dots Active Color', 'vw-stock-images-pro'),
'section' => 'vw_stock_images_pro_our_client_sec',
'settings' => 'vw_stock_images_pro_our_client_owl_dots_active_color',
)));
...
$wp_customize->add_setting('vw_stock_images_pro_radio_team_enable',
		array(
				'default' => 'Enable',
				'sanitize_callback' => 'vw_stock_images_pro_sanitize_choices'
));
$wp_customize->add_control('vw_stock_images_pro_radio_team_enable',
		array(
				'type' => 'radio',
				'label' => __('Do you want this section', 'vw-stock-images-pro'),
...
$wp_customize->add_setting( 'vw_stock_images_pro_team_section_setting',
array(
	'default' => '',
	'transport' => 'postMessage',
	'sanitize_callback' => 'vw_stock_images_pro_text_sanitization'
...
$wp_customize->add_control( new VW_Themes_Seperator_custom_Control( $wp_customize, 'vw_stock_images_pro_team_section_setting',
array(
	'label' => __('Section Typography ','vw-stock-images-pro'),
	'section' => 'vw_stock_images_pro_professional_team_sec'
)));
...
$wp_customize->add_setting( 'vw_stock_images_pro_team_section_color_font_setting',
array(
	'default' => '',
	'transport' => 'postMessage',
	'sanitize_callback' => 'vw_stock_images_pro_text_sanitization'
...
$wp_customize->add_control( new VW_Themes_Seperator_custom_Control( $wp_customize, 'vw_stock_images_pro_team_section_color_font_setting',
array(
	'label' => __('Section Color & Font Setting ','vw-stock-images-pro'),
	'section' => 'vw_stock_images_pro_professional_team_sec'
)));
...
$wp_customize->add_control(
		'vw_stock_images_pro_team_heading_font_family', array(
		'section'  => 'vw_stock_images_pro_professional_team_sec',
		'label'    => __('Heading Font family','vw-stock-images-pro'),
		'type'     => 'select',
		'choices'  => $font_array,
...
$wp_customize->add_control(
		'vw_stock_images_pro_team_paragraph_font_family', array(
		'section'  => 'vw_stock_images_pro_professional_team_sec',
		'label'    => __('Paragraph Font family','vw-stock-images-pro'),
		'type'     => 'select',
		'choices'  => $font_array,
...
$wp_customize->add_setting( 'vw_stock_images_pro_team_section_card_setting',
array(
	'default' => '',
	'transport' => 'postMessage',
	'sanitize_callback' => 'vw_stock_images_pro_text_sanitization'
...
$wp_customize->add_control( new VW_Themes_Seperator_custom_Control( $wp_customize, 'vw_stock_images_pro_team_section_card_setting',
array(
	'label' => __('Section Card Color & Font Setting ','vw-stock-images-pro'),
	'section' => 'vw_stock_images_pro_professional_team_sec'
)));
...
$wp_customize->add_control(
		'vw_stock_images_pro_team_name_font_family', array(
		'section'  => 'vw_stock_images_pro_professional_team_sec',
...
$wp_customize->add_control(
		'vw_stock_images_pro_team_desig_font_family', array(
		'section'  => 'vw_stock_images_pro_professional_team_sec',
...
$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'vw_stock_images_pro_team_card_hover_bg_color', array(
	...
	$wp_customize->add_setting('vw_stock_images_pro_latest_news_enable',
			array(
					'default' => 'Enable',
					'sanitize_callback' => 'vw_stock_images_pro_sanitize_choices'
	));
	$wp_customize->add_control('vw_stock_images_pro_latest_news_enable',
			array(
					'type' => 'radio',
					'label' => __('Do you want this section', 'vw-stock-images-pro'),
	...
	$wp_customize->add_setting( 'vw_stock_images_pro_latest_news_settings',
	 array(
	 'default' => '',
	 'transport' => 'postMessage',
	 'sanitize_callback' => 'vw_stock_images_pro_text_sanitization'
 ));
 $wp_customize->add_control( new VW_Themes_Seperator_custom_Control( $wp_customize, 'vw_stock_images_pro_latest_news_settings',
	 array(
	 'label' => __('Section Typography','vw-stock-images-pro'),
 ...
 $wp_customize->add_control('vw_stock_images_pro_latest_news_btn_url',array(
 	...
 	$wp_customize->add_setting( 'vw_stock_images_pro_latest_news_color_font_settings',
 	 array(
 	 'default' => '',
 	 'transport' => 'postMessage',
 	 'sanitize_callback' => 'vw_stock_images_pro_text_sanitization'
  ));
  $wp_customize->add_control( new VW_Themes_Seperator_custom_Control( $wp_customize, 'vw_stock_images_pro_latest_news_color_font_settings',
 	 array(
 	 'label' => __('Section Color & Font Setting','vw-stock-images-pro'),
 	 'section' => 'vw_stock_images_pro_latest_news_sec'
  )));
 ...
 $wp_customize->add_control(
	 'vw_stock_images_pro_latest_news_heading_font_family', array(
	 'section'  => 'vw_stock_images_pro_latest_news_sec',
	 'label'    => __( ' Heading Font Family','vw-stock-images-pro'),
	 'type'     => 'select',
	 'choices'  => $font_array
 ...
 $wp_customize->add_control(
	 'vw_stock_images_pro_latest_news_paragraph_font_family', array(
	 'section'  => 'vw_stock_images_pro_latest_news_sec',
	 'label'    => __( 'Paragraph Font Family','vw-stock-images-pro'),
	 'type'     => 'select',
	 'choices'  => $font_array
 ...
 $wp_customize->add_control(
 	'vw_stock_images_pro_latest_news_btn_font_family', array(
 	'section'  => 'vw_stock_images_pro_latest_news_sec',
 	'label'    => __( 'Button Font Family','vw-stock-images-pro'),
 	'type'     => 'select',
 	'choices'  => $font_array
 ...
 $wp_customize->add_setting( 'vw_stock_images_pro_latest_news_card_content_settings',
	array(
	'default' => '',
	'transport' => 'postMessage',
	'sanitize_callback' => 'vw_stock_images_pro_text_sanitization'
));
$wp_customize->add_control( new VW_Themes_Seperator_custom_Control( $wp_customize, 'vw_stock_images_pro_latest_news_card_content_settings',
	array(
	...
	$wp_customize->add_control(
	 'vw_stock_images_pro_latest_news_card_title_font_family', array(
	 'section'  => 'vw_stock_images_pro_latest_news_sec',
	...
	$wp_customize->add_control(
	 'vw_stock_images_pro_latest_news_card_para_font_family', array(
	 'section'  => 'vw_stock_images_pro_latest_news_sec',
	...
	$wp_customize->add_control(
	 'vw_stock_images_pro_latest_news_card_meta_font_family', array(
	 'section'  => 'vw_stock_images_pro_latest_news_sec',
	...
	$wp_customize->add_control(
	 'vw_stock_images_pro_latest_news_card_category_font_family', array(
	 'section'  => 'vw_stock_images_pro_latest_news_sec',
	...
	$wp_customize->add_setting('vw_stock_images_pro_gallery_enabledisable',
		array(
				'default' => 'Enable',
				'sanitize_callback' => 'vw_stock_images_pro_sanitize_choices'
		));
		$wp_customize->add_control('vw_stock_images_pro_gallery_enabledisable',
	array(
			'type' => 'radio',
	...
	$wp_customize->add_setting( 'vw_stock_images_pro_gallery_section_settings',
	array(
		'default' => '',
		'transport' => 'postMessage',
		'sanitize_callback' => 'vw_stock_images_pro_text_sanitization'
	));
	$wp_customize->add_control( new VW_Themes_Seperator_custom_Control( $wp_customize, 'vw_stock_images_pro_gallery_section_settings',
	array(
		'label' => __('Section Typoghraphy','vw-stock-images-pro'),
		'section' => 'vw_stock_images_pro_gallery_sec'
	)));
	...
	// $wp_customize->add_setting('vw_stock_images_pro_gallery_number',array(
	// 	'default'	=> __('','vw-stock-images-pro'),
	// 	'sanitize_callback'	=> 'sanitize_text_field'
	// ));
	// $wp_customize->add_control('vw_stock_images_pro_gallery_number',array(
	// 	'label'	=> __('Counter Number','vw-stock-images-pro'),
	// 	'section'	=> 'vw_stock_images_pro_gallery_sec',
	// 	'setting'	=> 'vw_stock_images_pro_gallery_number',
	// 	'type'		=> 'Number'
	// ));

	$no_cards=get_theme_mod('vw_stock_images_pro_gallery_number');
	for ($i=1; $i <= $no_cards ; $i++) {
		$wp_customize->add_setting( 'vw_stock_images_pro_gallery_number_settings'.$i,
		array(
			'default' => '',
			'transport' => 'postMessage',
			'sanitize_callback' => 'vw_stock_images_pro_text_sanitization'
		));
		$wp_customize->add_control( new VW_Themes_Seperator_custom_Control( $wp_customize, 'vw_stock_images_pro_gallery_number_settings'.$i,
		array(
	...
	$wp_customize->add_setting( 'vw_stock_images_pro_gallery_section_typoghraphy',
	array(
		'default' => '',
		'transport' => 'postMessage',
		'sanitize_callback' => 'vw_stock_images_pro_text_sanitization'
	));
	$wp_customize->add_control( new VW_Themes_Seperator_custom_Control( $wp_customize, 'vw_stock_images_pro_gallery_section_typoghraphy',
	array(
		'label' => __('Section Typoghraphy','vw-stock-images-pro'),
		'section' => 'vw_stock_images_pro_gallery_sec'
	)));
	...
	$wp_customize->add_control(
	 'vw_stock_images_pro_gallery_heading_font_family', array(
	 'section'  => 'vw_stock_images_pro_gallery_sec',
	 'label'    => __( 'Heading Font Family','vw-stock-images-pro'),
	 'type'     => 'select',
	 'choices'  => $font_array
	...
	$wp_customize->add_control(
	 'vw_stock_images_pro_gallery_paragraph_font_family', array(
	 'section'  => 'vw_stock_images_pro_gallery_sec',
	 'label'    => __( 'Paragraph Font Family','vw-stock-images-pro'),
	 'type'     => 'select',
	 'choices'  => $font_array
	...
	$wp_customize->add_setting('vw_stock_images_pro_partners_enable',
		array(
				'default' => 'Enable',
				'sanitize_callback' => 'vw_stock_images_pro_sanitize_choices'
		));
		$wp_customize->add_control('vw_stock_images_pro_partners_enable',
	array(
			'type' => 'radio',
			'label' => 'Do you want this section',
	...
	$wp_customize->add_setting( 'vw_stock_images_pro_partners_section_typoghraphy',
	array(
		'default' => '',
		'transport' => 'postMessage',
		'sanitize_callback' => 'vw_stock_images_pro_text_sanitization'
	));
	$wp_customize->add_control( new VW_Themes_Seperator_custom_Control( $wp_customize, 'vw_stock_images_pro_partners_section_typoghraphy',
	array(
		'label' => __('Section Color & Font Setting','vw-stock-images-pro'),
		'section' => 'vw_stock_images_pro_partners_sec'
	)));
	...
	$wp_customize->add_control(
	 'vw_stock_images_pro_partners_heading_font_family', array(
	 'section'  => 'vw_stock_images_pro_partners_sec',
	 'label'    => __( 'Heading Font Family','vw-stock-images-pro'),
	 'type'     => 'select',
	 'choices'  => $font_array
	...
	$wp_customize->add_control(
	 'vw_stock_images_pro_partners_paragraph_font_family', array(
	 'section'  => 'vw_stock_images_pro_partners_sec',
	 'label'    => __( 'Paragraph Font Family','vw-stock-images-pro'),
	 'type'     => 'select',
	 'choices'  => $font_array
	...
	for ($i=1; $i <= $no_cards ; $i++) {
		$wp_customize->add_setting( 'vw_stock_images_pro_partners_number_settings'.$i,
		array(
			'default' => '',
			'transport' => 'postMessage',
			'sanitize_callback' => 'vw_stock_images_pro_text_sanitization'
		));
		$wp_customize->add_control( new VW_Themes_Seperator_custom_Control( $wp_customize, 'vw_stock_images_pro_partners_number_settings'.$i,
		array(
  ...
  $wp_customize->add_setting( 'vw_stock_images_pro_post_general_settings_post_date',
   array(
      'default' => 1,
      'transport' => 'refresh',
      'sanitize_callback' => 'vw_stock_images_pro_switch_sanitization'
  ));
  $wp_customize->add_control( new vw_stock_images_pro_Toggle_Switch_Custom_control( $wp_customize, 'vw_stock_images_pro_post_general_settings_post_date',
     array(
        'label' => esc_html__( 'Show or Hide Post Date', 'vw-stock-images-pro' ),
        'section' => 'vw_stock_images_pro_post_general_settings'
  )));
  $wp_customize->add_setting( 'vw_stock_images_pro_post_general_settings_post_comments',
   array(
      'default' => 1,
      'transport' => 'refresh',
      'sanitize_callback' => 'vw_stock_images_pro_switch_sanitization'
  ));
  $wp_customize->add_control( new vw_stock_images_pro_Toggle_Switch_Custom_control( $wp_customize, 'vw_stock_images_pro_post_general_settings_post_comments',
     array(
        'label' => esc_html__( 'Show or Hide Comments', 'vw-stock-images-pro' ),
        'section' => 'vw_stock_images_pro_post_general_settings'
     )
  ));
  $wp_customize->add_setting( 'vw_stock_images_pro_post_general_settings_category_setting',
   array(
      'default' => 1,
      'transport' => 'refresh',
      'sanitize_callback' => 'vw_stock_images_pro_switch_sanitization'
  ));
  $wp_customize->add_control( new vw_stock_images_pro_Toggle_Switch_Custom_control( $wp_customize, 'vw_stock_images_pro_post_general_settings_category_setting',
     array(
        'label' => esc_html__( 'Show or Hide Category', 'vw-stock-images-pro' ),
        'section' => 'vw_stock_images_pro_post_general_settings'
     )
  ));
  $wp_customize->add_setting( 'vw_stock_images_pro_post_general_settings_post_author',
   array(
      'default' => 1,
      'transport' => 'refresh',
      'sanitize_callback' => 'vw_stock_images_pro_switch_sanitization'
  ...
  $wp_customize->add_control( new vw_stock_images_pro_Toggle_Switch_Custom_control( $wp_customize, 'vw_stock_images_pro_post_general_settings_post_author',
     array(
        'label' => esc_html__( 'Show or Hide Author', 'vw-stock-images-pro' ),
        'section' => 'vw_stock_images_pro_post_general_settings'
     )
  ));
  $wp_customize->add_setting( 'vw_stock_images_pro_post_general_settings_post_share',
   array(
      'default' => 1,
      'transport' => 'refresh',
      'sanitize_callback' => 'vw_stock_images_pro_switch_sanitization'
  ...
  $wp_customize->add_control( new vw_stock_images_pro_Toggle_Switch_Custom_control( $wp_customize, 'vw_stock_images_pro_post_general_settings_post_share',
     array(
        'label' => esc_html__( 'Show or Hide Share Icons', 'vw-stock-images-pro' ),
        'section' => 'vw_stock_images_pro_post_general_settings'
     )
  ));
  $wp_customize->add_setting( 'vw_stock_images_pro_post_general_settings_post_share_facebook',
   array(
      'default' => 1,
      'transport' => 'refresh',
      'sanitize_callback' => 'vw_stock_images_pro_switch_sanitization'
  ...
  $wp_customize->add_control( new vw_stock_images_pro_Toggle_Switch_Custom_control( $wp_customize, 'vw_stock_images_pro_post_general_settings_post_share_facebook',
     array(
        'label' => esc_html__( 'Post Share Facebook', 'vw-stock-images-pro' ),
        'section' => 'vw_stock_images_pro_post_general_settings'
     )
  ));
  $wp_customize->add_setting( 'vw_stock_images_pro_post_general_settings_post_share_linkedin',
   array(
      'default' => 1,
      'transport' => 'refresh',
      'sanitize_callback' => 'vw_stock_images_pro_switch_sanitization'
  ...
  $wp_customize->add_control( new vw_stock_images_pro_Toggle_Switch_Custom_control( $wp_customize, 'vw_stock_images_pro_post_general_settings_post_share_linkedin',
     array(
        'label' => esc_html__( 'Post Share Linkedin', 'vw-stock-images-pro' ),
        'section' => 'vw_stock_images_pro_post_general_settings'
     )
  ));
  $wp_customize->add_setting( 'vw_stock_images_pro_post_general_settings_post_share_twitter',
   array(
      'default' => 1,
      'transport' => 'refresh',
      'sanitize_callback' => 'vw_stock_images_pro_switch_sanitization'
  ...
  $wp_customize->add_control( new vw_stock_images_pro_Toggle_Switch_Custom_control( $wp_customize, 'vw_stock_images_pro_post_general_settings_post_share_twitter',
     array(
	...
	$wp_customize->add_setting( 'vw_stock_images_pro_blog_page_color_typoghraphy',
	array(
		'default' => '',
		'transport' => 'postMessage',
		'sanitize_callback' => 'vw_stock_images_pro_text_sanitization'
	));
	$wp_customize->add_control( new VW_Themes_Seperator_custom_Control( $wp_customize, 'vw_stock_images_pro_blog_page_color_typoghraphy',
	array(
		'label' => __('Section Color & Font Setting','vw-stock-images-pro'),
		'section' => 'vw_stock_images_pro_post_general_settings'
	)));
	...
	$wp_customize->add_control(
			'vw_stock_images_pro_blog_page_meta_font_family', array(
			'section'  => 'vw_stock_images_pro_post_general_settings',
	...
	$wp_customize->add_control(
			'vw_stock_images_pro_blog_page_content_font_family', array(
			'section'  => 'vw_stock_images_pro_post_general_settings',
			'label'    => __('Content Font family','vw-stock-images-pro'),
			'type'     => 'select',
			'choices'  => $font_array,
	...
	$wp_customize->add_control(
			'vw_stock_images_pro_blog_page_inner_header_font_family', array(
			'section'  => 'vw_stock_images_pro_post_general_settings',
			'label'    => __('Question Font family','vw-stock-images-pro'),
			'type'     => 'select',
			'choices'  => $font_array,
  ...
  $wp_customize->add_section('vw_stock_images_pro_post_product_general_settings',array(
   ...
   $wp_customize->add_setting( 'vw_stock_images_pro_products_spinner_settings',
    array(
    'default' => '',
    'transport' => 'postMessage',
    'sanitize_callback' => 'vw_stock_images_pro_text_sanitization'
  ));
  $wp_customize->add_control( new VW_Themes_Seperator_custom_Control( $wp_customize, 'vw_stock_images_pro_products_spinner_settings',
    array(
    'label' => __('Spinner Settings','vw-stock-images-pro'),
    'section' => 'vw_stock_images_pro_post_product_general_settings'
  )));
  $wp_customize->add_setting( 'vw_stock_images_pro_products_spinner_enable',
   array(
      'default' => 1,
      'transport' => 'refresh',
      'sanitize_callback' => 'vw_stock_images_pro_switch_sanitization'
  ));
  $wp_customize->add_control( new vw_stock_images_pro_Toggle_Switch_Custom_control( $wp_customize, 'vw_stock_images_pro_products_spinner_enable',
     array(
 ...
 $wp_customize->add_setting( 'vw_stock_images_pro_general_settings_scroll_top',
    array(
    'default' => '',
    'transport' => 'postMessage',
    'sanitize_callback' => 'vw_stock_images_pro_text_sanitization'
  ));
  $wp_customize->add_control( new VW_Themes_Seperator_custom_Control( $wp_customize, 'vw_stock_images_pro_general_settings_scroll_top',
    array(
    'label' => __('Scroll Top Settings','vw-stock-images-pro'),
    'section' => 'vw_stock_images_pro_post_product_general_settings'
  )));

   $wp_customize->add_setting( 'vw_stock_images_pro_genral_section_show_scroll_top',
   array(
      'default' => 1,
      'transport' => 'refresh',
      'sanitize_callback' => 'vw_stock_images_pro_switch_sanitization'
    ));
    $wp_customize->add_control( new vw_stock_images_pro_Toggle_Switch_Custom_control( $wp_customize, 'vw_stock_images_pro_genral_section_show_scroll_top',
         array(
  ...
  $wp_customize->add_setting( 'vw_stock_images_pro_site_frame_settings',
    array(
    'default' => '',
    'transport' => 'postMessage',
    'sanitize_callback' => 'vw_stock_images_pro_text_sanitization'
