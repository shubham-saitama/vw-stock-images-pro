		...
		<div class="container">
			<div class="row justify-content-center align-items-center">
				<div class="col-md-6 col-sm-6">
					...
					<p class="copyright-text">© 2024 -
						<?php if (get_theme_mod('vw_furniture_pro_credit_link', true) != '') { ?>
							<span class="credit_link"><?php echo esc_html(vw_stock_images_pro_credit_link()); ?></span>
							<?php echo get_theme_mod('vw_stock_images_pro_footer_copyright_para'); ?>
						</p>
					<?php } ?>

					<?php if (get_theme_mod('vw_stock_images_pro_genral_section_show_scroll_top', true) == "1") { ?>
						<a href="javascript:" id="return-to-top"><i
								class="<?php echo esc_html(get_theme_mod('vw_stock_images_pro_genral_section_show_scroll_top_icon')); ?>"></i><span
								class="screen-reader-text"><?php esc_html_e('Return To Top Button', 'vw-stock-images-pro') ?></span></a>
					<?php } ?>
				</div>
				<div class="col-lg-6 col-md-6">
					<div class="row align-items-center justify-content-end">
						<div class="translate col-lg-2">
